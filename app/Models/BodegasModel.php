...
class BodegasModel extends BaseModel
{
    ...
    // update_item_bodega ELIMINADO — bypaseaba inventario_capas + costos_item
    // y no registraba en movimiento_inventario. Reemplazo: CatalogoController
    // para atributos del item, y los flujos transaccionales (OC, Producción,
    // Traspaso, AjusteManual) para cualquier mutación de stock o costo.
}
