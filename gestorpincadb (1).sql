...
--
-- Servidor: db
-- Tiempo de generación: 12-05-2026 a las 18:43:47
...
(203, 230, 5378.00, NULL, 0, 0, NULL, 'PROMED', '2026-05-12', NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL);
...
(275, 50.00, '2026-05-12', NULL, 230, 1, NULL, 1, 1);
...
(99, 230, 1, 23, 46, 16, 50.0000, 50.0000, 5378.0000, NULL, 1.000000, 5378.0000, '2026-05-12 00:29:03', NULL, NULL, 1);
...
(230, 'DISPERSANTE', NULL, 2, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5378.00, NULL, 0, 9),
...
CREATE TABLE `login_attempts` (
  ...
  `username_attempt` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(1, '172.18.0.1', 'root', '2026-05-12 00:00:57'),
(2, '172.18.0.1', 'root', '2026-05-12 00:02:25'),
(3, '172.18.0.1', 'admin', '2026-05-12 00:18:45'),
(4, '172.18.0.1', 'root', '2026-05-12 00:19:06'),
(5, '172.18.0.1', 'root', '2026-05-12 00:19:08'),
(6, '172.18.0.1', 'root', '2026-05-12 00:19:10'),
(7, '172.18.0.1', 'root', '2026-05-12 00:19:12');
...
(16, 'OC-001', 23, 1, '2026-05-12', '2026-05-20', 'Recibida', 268900.00, 'OC de prueba Phase 6', '2026-05-12 00:28:33');
...
(27, 16, 46, 230, NULL, 50.00, 5378.00, 268900.00, 50.00, '2026-05-12 00:29:03');
...
CREATE TABLE `permisos_rol_modulo` (
  ...
  `modulo` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `rol` enum('admin','operador','visor') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'operador'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `usuarios` (`id_usuarios`, `username`, `password`, `rol`) VALUES
(2, 'root', '$2y$10$zcSxsrQHkHFxPddPk/.TFeeFceYqtUeb3wtlLSxfnDG4Ll5dL1Szu', 'admin');
...
--
ALTER TABLE `inventario_capas`
  MODIFY `id_capa` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
...
--
ALTER TABLE `ordenes_compra`
  MODIFY `id_orden` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `ordenes_compra_detalle`
--
ALTER TABLE `ordenes_compra_detalle`
  MODIFY `id_detalle` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
