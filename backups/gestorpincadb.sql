...
--
-- Servidor: db
-- Tiempo de generación: 30-05-2026 a las 16:00:02
...
INSERT INTO `bodegas` (`id_bodegas`, `nombre`, `descripcion`, `estado`, `instalaciones_id`, `deleted_at`) VALUES
(1, 'Bodega principal', 'BODEGA INSUMOS, MATERIAS PRIMAS Y PRODUCTOS', 1, 1, NULL),
(2, 'Bodega 1', 'Aditivos técnicos, impermeabilizantes de alto desempeño y maquinaria pesada.', 1, 2, NULL),
(3, 'Juan Mina', 'Punto estratégico en la Vía Cordialidad, orientado al manejo de inventarios y distribución regional, con conexiones hacia rutas intermunicipales.', 1, 3, NULL),
(8, 'Laboratorio', 'Área de bodega con acondicionamiento tipo laboratorio', 1, 1, NULL),
(15, 'Centro de insumos', 'Área destinada al almacenamiento y distribución de insumos.', 1, 1, NULL),
(16, 'Depósito especializado', 'Espacio seguro para almacenamiento bajo condiciones controladas.', 0, 1, NULL),
(18, 'Bodega 2', 'Resinas base, solventes y una amplia gama de pinturas para acabados horneables.', 1, 2, NULL),
(19, 'Bodega 3', 'Estación de colorimetría con pastas pigmentadas, anticorrosivos y productos listos para despacho.', 1, 2, NULL),
(21, 'Patio', 'Almacenamiento masivo de solventes industriales, aglutinantes y selladores por volumen.', 1, 2, NULL);
...
INSERT INTO `clientes` (`id_clientes`, `nombre_encargado`, `nombre_empresa`, `numero_documento`, `direccion`, `ciudad`, `plazo_pago`, `telefono`, `email`, `tipo`, `estado`, `dias_credito`, `limite_credito`, `credito_usado`, `deleted_at`) VALUES
(1, 'Carlos Mendoza', 'Distribuidora Andina S.A.S', 900123456, 'Calle 45 #32-10, Barranquilla', NULL, 30, 3014567890, 'c.mendoza@andina.com', 2, 1, 30, 5000000.00, 125000.00, NULL),
(2, 'Juliana Pérez', 'Soluciones del Caribe Ltda', 801987654, 'Carrera 21 #55-22, Cartagena', NULL, 30, 3157894321, 'juliana.perez@caribe.com', 1, 2, 60, 10000000.00, 0.00, NULL),
(3, 'Mauricio Torres', 'Pinturas Torres & Cía', 1023456789, 'Av. Murillo #12-80, Barranquilla', NULL, 30, 3001122334, 'm.torres@ptorres.com', 2, 1, 30, 0.00, 0.00, NULL),
(21, NULL, 'Cliente Soft Delete Test 6a04d3f18d3e0', 999591882, NULL, NULL, 30, NULL, NULL, 2, 1, 30, 0.00, 0.00, '2026-05-13 19:41:38'),
(23, NULL, 'Cliente Soft Delete Test 6a04d42031ae0', 999146893, NULL, NULL, 30, NULL, NULL, 2, 1, 30, 0.00, 0.00, '2026-05-13 19:42:25');
...
INSERT INTO `configuracion_sistema` (`id_configuracion`, `grupo`, `clave`, `valor`, `tipo`, `descripcion`, `updated_at`, `updated_by`) VALUES
(1, 'tributaria', 'iva_default', '19', 'number', 'Porcentaje IVA general (%) aplicado por defecto en facturas y compras.', '2026-05-25 16:05:32', 'seed'),
(2, 'tributaria', 'retencion_fuente_pct', '2.5', 'number', 'Retención en la fuente por compra (%) — varía por concepto y régimen.', '2026-05-25 16:05:32', 'seed'),
(3, 'tributaria', 'retencion_iva_pct', '15', 'number', 'ReteIVA: porcentaje del IVA pagado que se retiene al proveedor (%).', '2026-05-25 16:05:32', 'seed'),
(4, 'tributaria', 'retencion_ica_default', '11.04', 'number', 'ReteICA por mil — default Barranquilla. Ajustar por ciudad/actividad.', '2026-05-25 16:05:32', 'seed'),
(5, 'tributaria', 'aplicar_iva_por_default', 'true', 'boolean', 'Si true, los formularios de compra activan el toggle IVA al abrirse.', '2026-05-25 16:05:32', 'seed'),
(6, 'umbrales', 'stock_critico_dias', '7', 'number', 'Días restantes de stock para considerar una MP \"crítica\" (rojo en dashboard / inventario).', '2026-05-25 16:05:32', 'seed'),
(7, 'umbrales', 'stock_warning_dias', '30', 'number', 'Días restantes para \"advertencia\" (amarillo). Por encima → \"ok\" (verde).', '2026-05-25 16:05:32', 'seed'),
(8, 'umbrales', 'mora_warning_dias', '30', 'number', 'Días de mora desde los cuales una factura entra en alerta amarilla.', '2026-05-25 16:05:32', 'seed'),
(9, 'umbrales', 'mora_critica_dias', '60', 'number', 'Días de mora desde los cuales una factura entra en alerta roja (crítica).', '2026-05-25 16:05:32', 'seed'),
(10, 'umbrales', 'margen_minimo_pct', '10', 'number', 'Margen (%) por debajo del cual el dashboard marca rentabilidad en rojo.', '2026-05-25 16:05:32', 'seed'),
(11, 'umbrales', 'margen_objetivo_pct', '20', 'number', 'Margen (%) objetivo: por encima la rentabilidad se muestra en verde.', '2026-05-25 16:05:32', 'seed'),
(12, 'seguridad', 'jwt_expiracion_horas', '8', 'number', 'Horas de validez del JWT desde su emisión. Tras este tiempo el usuario debe re-loguearse.', '2026-05-25 16:05:32', 'seed'),
(13, 'seguridad', 'max_intentos_login', '5', 'number', 'Cantidad máxima de intentos de login fallidos antes de bloquear la IP temporalmente.', '2026-05-25 16:05:32', 'seed'),
(14, 'seguridad', 'ventana_intentos_segundos', '900', 'number', 'Ventana en segundos durante la cual se cuentan los intentos fallidos (default 900 = 15 min).', '2026-05-25 16:05:32', 'seed'),
(15, 'seguridad', 'password_min_caracteres', '8', 'number', 'Longitud mínima requerida para contraseñas nuevas.', '2026-05-25 16:05:32', 'seed'),
(16, 'financiero', 'margen_utilidad_default_pct', '50', 'number', 'Margen de utilidad por defecto (%) cuando un costo no tiene `porcentaje_utilidad` explícito.', '2026-05-25 16:05:32', 'seed'),
(17, 'comercial', 'dias_vencimiento_factura', '30', 'number', 'Días desde la emisión hasta el vencimiento por default al crear/convertir una factura.', '2026-05-25 16:05:32', 'seed'),
(18, 'comercial', 'dias_credito_default', '30', 'number', 'Plazo de pago por default sugerido al crear un cliente nuevo.', '2026-05-25 16:05:32', 'seed'),
(19, 'notificaciones', 'limit_default', '30', 'number', 'Cantidad de notificaciones a devolver por defecto en la query.', '2026-05-25 16:05:32', 'seed'),
(20, 'notificaciones', 'limit_maximo', '100', 'number', 'Tope superior absoluto para evitar payloads excesivos.', '2026-05-25 16:05:32', 'seed'),
(21, 'notificaciones', 'dias_alerta_vencimiento', '3', 'number', 'Días previos al vencimiento de una factura para empezar a notificar.', '2026-05-25 16:05:32', 'seed'),
(22, 'paginacion', 'page_size_default', '25', 'number', 'Cantidad de filas por página default en tablas listables.', '2026-05-25 16:05:32', 'seed'),
(23, 'paginacion', 'max_per_page', '200', 'number', 'Tope máximo permitido para `?per_page=` en endpoints paginados.', '2026-05-25 16:05:32', 'seed'),
(24, 'apariencia', 'avatar_palette', '[{\"key\": \"default\", \"grad\": null, \"name\": \"Por rol\", \"preview\": \"from-zinc-400  to-zinc-600\"}, {\"key\": \"violet\", \"grad\": \"from-violet-500  to-purple-600\", \"name\": \"Violeta\", \"preview\": \"from-violet-500 to-purple-600\"}, {\"key\": \"blue\", \"grad\": \"from-blue-500    to-cyan-600\", \"name\": \"Azul\", \"preview\": \"from-blue-500   to-cyan-600\"}, {\"key\": \"emerald\", \"grad\": \"from-emerald-500 to-teal-600\", \"name\": \"Esmeralda\", \"preview\": \"from-emerald-500 to-teal-600\"}, {\"key\": \"amber\", \"grad\": \"from-amber-500   to-orange-600\", \"name\": \"Ámbar\", \"preview\": \"from-amber-500  to-orange-600\"}, {\"key\": \"rose\", \"grad\": \"from-rose-500    to-pink-600\", \"name\": \"Rosa\", \"preview\": \"from-rose-500   to-pink-600\"}, {\"key\": \"slate\", \"grad\": \"from-slate-600   to-zinc-800\", \"name\": \"Pizarra\", \"preview\": \"from-slate-600  to-zinc-800\"}, {\"key\": \"indigo\", \"grad\": \"from-indigo-500  to-fuchsia-600\", \"name\": \"Índigo\", \"preview\": \"from-indigo-500 to-fuchsia-600\"}]', 'json', 'Paleta de gradientes que cada usuario puede elegir para su avatar. Array JSON: [{key, name, grad, preview}].', '2026-05-25 16:05:32', 'seed');
...
(58, 2, 0.00, 0, 0, 0, NULL, 'MANUAL', '2025-06-07', 0, 3600.00, 350.00, 140, 153, 212, 20000.00, 0, 600, NULL, 75),
...
(203, 230, 5157.50, NULL, 0, 0, NULL, 'PROMED', '2026-05-25', NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL),
(204, 300, 5040.00, 0, 0, 0, '2026-05', 'PROMED', '2026-05-27', 0, 0.00, 0.00, 0, 0, 1, 0.00, NULL, 0, 1, NULL),
(205, 301, 7620.00, 0, 0, 0, '2026-05', 'PROMED', '2026-05-17', 0, 0.00, 0.00, 0, 0, 1, 0.00, NULL, 0, 1, NULL),
(206, 302, 0.00, 0, 0, 0, '2026-05', 'Catálo', '2026-05-16', 0, 0.00, 0.00, 0, 0, 1, 0.00, NULL, 0, 1, NULL);
...
--
-- Estructura de tabla para la tabla `costos_snapshot`
--

CREATE TABLE `costos_snapshot` (
  `id_costos_snapshot` int UNSIGNED NOT NULL,
...
INSERT INTO `empresa` (`id_empresa`, `nit`, `razon_social`, `descripcion`, `ciudad`, `direccion`, `telefono`, `celular`, `pagina_web`, `email`, `locale`, `moneda`, `logo_path`) VALUES
...
INSERT INTO `formulaciones` (`id_formulaciones`, `nombre`, `descripcion`, `estado`, `defecto`, `version_actual`, `item_general_id`) VALUES
(1, 'PREPARACION BARNIZ TRANSPARENTE BRILLANTE', NULL, 1, 1, 2, 1),
(2, 'PREPARACION ESMALTE BLANCO', NULL, 1, 1, 2, 2),
(3, 'PREPARACION ESMALTE CAOBA', NULL, 1, 1, 1, 3),
(4, 'PREPARACION ESMALTE NEGRO MATE', NULL, 1, 1, 1, 4),
(5, 'PREPARACION ESMALTE ROJO FIESTA', NULL, 1, 1, 2, 5),
(6, 'PREPARACION ESMALTE NEGRO BRILLANTE', NULL, 1, 1, 1, 6),
(7, 'PREPARACION ESMALTE VERDE ESMERALDA', NULL, 1, 1, 1, 7),
(8, 'PREPARACION ESMALTE GRIS PLATA', NULL, 1, 1, 1, 8),
(9, 'PREPARACION ESMALTE AZUL ESPAÑOL', NULL, 1, 1, 1, 9),
(10, 'PREPARACION ESMALTE BLANCO MATE', NULL, 1, 1, 1, 10),
(11, 'PREPARACION ESMALTE AMARILLO', NULL, 1, 1, 2, 11),
(12, 'PREPARACION ESMALTE NARANJA', NULL, 1, 1, 1, 12),
(13, 'PREPARACION ESMALTE TABACO', NULL, 1, 1, 1, 13),
(14, 'PREPARACION ANTICORROSIVO GRIS', NULL, 1, 1, 2, 14),
(15, 'PREPARACION ANTICORROSIVO NEGRO', NULL, 1, 1, 2, 15),
(16, 'PREPARACION ANTICORROSIVO AMARILLO', NULL, 1, 1, 1, 16),
(17, 'PREPARACION ANTICORROSIVO ROJO', NULL, 1, 1, 1, 17),
(18, 'PREPARACION ANTICORROSIVO BLANCO', NULL, 1, 1, 2, 18),
(19, 'PREPARACION ANTICORROSIVO VERDE', NULL, 1, 1, 2, 19),
(20, 'PREPARACION PASTA ESMALTE VERDE ENTONADOR', NULL, 1, 1, 1, 20),
(21, 'PREPARACION PASTA ESMALTE AZUL ENTONADOR', NULL, 1, 1, 1, 21),
(22, 'PREPARACION PASTA ESMALTE NEGRO', NULL, 1, 1, 1, 22),
(23, 'PREPARACION PASTA ESMALTE ROJO CARMIN 57:1', NULL, 1, 1, 1, 23),
(24, 'PREPARACION PASTA ESMALTE NARANJA', NULL, 1, 1, 1, 24),
(25, 'PREPARACION PASTA ESMALTE AMARILLO', NULL, 1, 1, 1, 25),
(26, 'PREPARACION PASTA ESMALTE CAOBA', NULL, 1, 1, 1, 26),
(27, 'PREPARACION PASTA ESMALTE AMARILLO OXIDO', NULL, 1, 1, 1, 27),
(28, 'PREPARACION PASTA ESMALTE ROJO OXIDO', NULL, 1, 1, 1, 28),
(29, 'PREPARACION PASTA ESMALTE BLANCO', NULL, 1, 1, 1, 29),
(30, 'PREPARACION PASTA ESMALTE TABACO', NULL, 1, 1, 1, 30),
(31, 'FORMULACION VINILO T1 BLANCO', NULL, 1, 1, 1, 133),
(32, 'FORMULACION EPOXICA TRANSPARENTE', NULL, 1, 1, 1, 224),
(33, 'FORMULACION VINILO BLANCO TIPO 2', NULL, 1, 1, 1, 275),
(34, 'FORMULACION VINILO BLANCO TIPO 3', NULL, 1, 1, 1, 276),
(35, 'FORMULACION ESMALTE AZUL REAL', NULL, 1, 1, 1, 277),
(36, 'FORMULACION LACA CATALIZADA BRILLANTE', NULL, 1, 1, 1, 278),
(37, 'FORMULACION PASTA OCRE PARA VINILO', NULL, 1, 1, 1, 279),
(38, 'FORMULACION VINILO OCRE T1', NULL, 1, 1, 1, 280),
(39, 'FORMULACION ESMALTE AMARILLO CATERPILLAR', NULL, 1, 1, 1, 281),
(40, 'FORMULACION ESMALTE NEGRO', NULL, 1, 1, 1, 282),
(41, 'FORMULACION ESMALTE BLANCO T1', NULL, 1, 1, 1, 283),
(42, 'FORMULACION ESMALTE BLANCO 4X1', NULL, 1, 1, 1, 284),
(43, 'FORMULACION ESMALTE BLANCO ECONOMICO JJ', NULL, 1, 1, 1, 285),
(44, 'FORMULACION ESMALTE ECONOMICO BLANCO JH', NULL, 1, 1, 1, 286),
(45, 'FORMULACION ESMALTE DORADO', NULL, 1, 1, 1, 287),
(46, 'FORMULACION ANTICORROSIVO CROMATO ZN', NULL, 1, 1, 1, 288),
(47, 'FORMULACION ESMALTE DE ALUMINIO', NULL, 1, 1, 1, 289),
(48, 'FORMULACION EPOXICA BLANCO', NULL, 1, 1, 1, 290),
(49, 'FORMULACION EPOXICA NEGRA', NULL, 1, 1, 1, 291),
(50, 'FORMULACION EPOXICA GRIS', NULL, 1, 1, 1, 292),
(51, 'FORMULACION EPOXICA NEGRA RESINA 100%', NULL, 1, 1, 1, 293),
(52, 'FORMULACION EPOXICA POLIAMIDA VERDE', NULL, 1, 1, 1, 294),
(53, 'FORMULACION EPOXICA AZUL', NULL, 1, 1, 1, 295),
(54, 'FORMULACION EPOXICA ROJO OXIDO', NULL, 1, 1, 1, 296),
(55, 'FORMULACION ESM EPOXI SILICATO BLANCO', NULL, 1, 1, 1, 297),
(56, 'FORMULACION ESM EPOXI SILICATO VERDE', NULL, 1, 1, 1, 298),
(57, 'FORMULACION ESMALTE EPOXICO AMARILLO', NULL, 1, 1, 1, 299);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `formulaciones_versiones`
--
...
INSERT INTO `instalaciones` (`id_instalaciones`, `nombre`, `descripcion`, `ciudad`, `direccion`, `telefono`, `id_empresa`, `deleted_at`) VALUES
(1, 'Sede Cordialidad', 'SEDE DE FABRICACIÓN DE PINTURAS', ' BARRANQUILLA', 'Calle 99 # 6-59', '3019794729', 1, NULL),
(2, 'Sede Villa Olimpica', 'SEDE DE FABRICACIÓN DE PINTURAS', 'Galapa', '', '3019794729', 1, NULL),
(3, 'Sede Juan Mina', 'SEDE DE FABRICACIÓN DE PINTURAS', 'Barranquilla', '', '3019794729', 1, NULL);
...
(171, 9.00, '2026-05-16', 0, 142, 0, NULL, 1, 2),
...
(178, 0.00, '2026-04-17', 0, 148, 0, NULL, 1, 18),
...
(185, 0.00, '2026-04-17', 0, 154, 0, NULL, 1, 18),
(186, 0.00, '2026-04-17', 0, 155, 0, NULL, 1, 18),
...
(205, 0.00, '2026-04-17', 0, 170, 0, NULL, 1, 18),
...
(212, 0.00, '2026-04-17', 0, 176, 0, NULL, 1, 18),
(213, 2.00, '2026-04-17', 0, 177, 0, NULL, 1, 18),
(214, 0.00, '2026-04-17', 0, 193, 0, NULL, 1, 18),
...
(220, 0.00, '2026-04-17', 0, 183, 0, NULL, 1, 18),
(221, 3.00, '2026-04-17', 0, 184, 0, NULL, 1, 18),
(222, 0.00, '2026-04-17', 0, 185, 0, NULL, 1, 18),
(223, 2.00, '2026-04-17', 0, 186, 0, NULL, 1, 18),
(224, 1.00, '2026-04-17', 0, 187, 0, NULL, 1, 18),
(225, 0.00, '2026-04-17', 0, 188, 0, NULL, 1, 18),
...
(238, 0.00, '2026-04-17', 0, 204, 0, NULL, 1, 19),
(239, 0.00, '2026-04-17', 0, 171, 0, NULL, 1, 19),
...
INSERT INTO `item_general` (`id_item_general`, `nombre`, `codigo`, `tipo`, `categoria_id`, `viscosidad`, `p_g`, `p_kg`, `color`, `brillo_60`, `secado`, `cubrimiento`, `molienda`, `ph`, `poder_tintoreo`, `unidad_id`, `costo_produccion`, `precio_venta_manual`, `precio_manual_activo`, `unidad_almacenaje_id`, `deleted_at`) VALUES
(1, 'BARNIZ TRANSPARENTE BRILLANTE', 'BAR001', 0, 1, '95-100 KU', '3,4+/-0,05 Kg', '', 'STD', '>=95', '12 HORAS', '', '', '', '', 5, 0.00, 56000.00, 1, 5, NULL),
(2, 'ESMALTE BLANCO', 'ESM002', 0, 1, '100-105 KU', '3,6+/-0,05 Kg', '', '', '>=90', '12 HORAS', '100+/-5 %', '', '', '', 4, 7000.00, NULL, 0, NULL, NULL),
(3, 'ESMALTE CAOBA', 'ESM003', 0, 1, '100-105 KU', '3,6+/-0,05 Kg', '', NULL, '>=90', '6 HORAS', '100+/-5%', '7.5 H', NULL, NULL, 3, 11000.00, NULL, 0, NULL, NULL),
(4, 'ESMALTE NEGRO MATE', 'ESM004', 0, 1, '105-110 KU', '3,9+/-0,05 Kg', '', NULL, '<=15', '12 HORAS', '100+/-5%', '6 H', NULL, NULL, 4, 34050.00, NULL, 0, NULL, NULL),
(5, 'ESMALTE ROJO FIESTA', 'ESM005', 0, 1, '100-105 KU', '3,6+/-0,05 Kg', '', '', '>= 90°', '12 HORAS', '100+/-5%', '', '', '', 1, 27144.00, NULL, 0, NULL, NULL),
(6, 'ESMALTE NEGRO BRILLANTE', 'ESM006', 0, 1, '100-105 KU', '3.4+/-0.05 Kg', '', '', '>= 90', '12 HORAS', '100+/-5%', '', '', '', 3, 12691.00, NULL, 0, NULL, NULL),
(7, 'ESMALTE VERDE ESMERALDA', 'ESM007', 0, 1, '100-105 KU', '3.6+/-0,05 Kg', '', '', '>=90', '12 HORAS', '100+/-5%', '', '', '', 1, 4372.00, NULL, 0, NULL, NULL),
(8, 'ESMALTE GRIS PLATA', 'ESM008', 0, 1, '100-105 KU', '3,6+/-0,05 Kg', '', '', '>=90', '12 HORAS', '100+/-5 %', '', '', '', 7, 11466.00, NULL, 0, NULL, NULL),
(9, 'ESMALTE AZUL ESPAÑOL', 'ESM009', 0, 1, '100-105 KU', '3,6+/-0,05 Kg', '', NULL, '>=90', '12 HORAS', '100+/-5 %', '7.5 H', NULL, NULL, NULL, 16300.00, NULL, 0, NULL, NULL),
(10, 'ESMALTE BLANCO MATE', 'ESM010', 0, 1, '95-100', '4,2 +/- 0,1 Kg', '', '', '15', '12 HORAS', '100+/-5', '', '', '', 3, 17000.00, NULL, 0, NULL, NULL),
(11, 'ESMALTE AMARILLO', 'ESM011', 0, 1, '100-105 KU', '3,6+/-0,05 Kg', '', NULL, '>=90', '12 HORAS', '100+/-5', '7.5 H', NULL, NULL, NULL, 4400.00, NULL, 0, NULL, NULL),
(12, 'ESMALTE NARANJA', 'ESM012', 0, 1, '100-105', '3.5+/-0.05', '', NULL, '>=90', '12 HORAS', '100+/-5', '7.5 H', NULL, NULL, NULL, 14300.00, NULL, 0, NULL, NULL),
(13, 'ESMALTE TABACO', 'ESM013', 0, 1, '100-105KU', '3.5+/-0.05', '', NULL, '>=90', '12 HORAS', '100+/-5', '7.5 H', NULL, NULL, NULL, 40.00, NULL, 0, NULL, NULL),
(14, 'ANTICORROSIVO GRIS', 'ANT014', 0, 3, '105-110 KU', '4.2+/-0.05 Kg', '', NULL, 'MATE', '6 HORAS', '100+/-5', '5,5', NULL, NULL, NULL, 1550.00, NULL, 0, NULL, NULL),
(15, 'ANTICORROSIVO NEGRO', 'ANT015', 0, 3, '105-110 KU', '4.2+/-0.05 Kg', '', NULL, 'MATE', '6 HORAS', '100+/-5', '5,5', NULL, NULL, NULL, 4617.00, NULL, 0, NULL, NULL),
(16, 'ANTICORROSIVO AMARILLO', 'ANT016', 0, 3, '105-110 KU', '4.2+/-0.05 Kg', '', NULL, 'MATE', '6 HORAS', '100+/-5', '5,5', NULL, NULL, NULL, 8640.00, NULL, 0, NULL, NULL),
(17, 'ANTICORROSIVO ROJO', 'ANT017', 0, 3, '105-110 KU', '4.2+/-0.05 Kg', '', NULL, 'MATE', '6 HORAS', '100+/-5', '5,5', NULL, NULL, NULL, 14300.00, NULL, 0, NULL, NULL),
(18, 'ANTICORROSIVO BLANCO', 'ANT018', 0, 3, '105-110 KU', '4.2+/-0.05 Kg', '', NULL, 'MATE', '6 HORAS', '100+/-5', '5,5', NULL, NULL, NULL, 855.00, NULL, 0, NULL, NULL),
(19, 'ANTICORROSIVO VERDE', 'ANT019', 0, 3, '105-110 KU', '4.2+/-0.05 Kg', '', NULL, 'MATE', '6 HORAS', '100+/-5', '5,5', NULL, NULL, NULL, 5400.00, NULL, 0, NULL, NULL),
(20, 'PASTA ESMALTE VERDE ENTONADOR', 'PAS020', 0, 2, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8105.00, NULL, 0, NULL, NULL),
(21, 'PASTA ESMALTE AZUL ENTONADOR', 'PAS021', 0, 2, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12215.00, NULL, 0, NULL, NULL),
(22, 'PASTA ESMALTE NEGRO', 'PAS022', 2, 2, '100 KU', '4,55', '', 'STD', NULL, NULL, NULL, '>7H', '-', 'STD', NULL, 19945.00, NULL, 0, NULL, NULL),
(23, 'PASTA ESMALTE ROJO CARMIN 57:1', 'PAS023', 0, 2, '100 KU', '5,55', '', 'STD', NULL, NULL, NULL, '>7H', '-', 'STD', NULL, 14152.00, NULL, 0, NULL, NULL),
(24, 'PASTA ESMALTE NARANJA', 'PAS024', 2, 2, '100 KU', '5,55', '', 'STD', NULL, NULL, NULL, '>7H', '-', 'STD', NULL, 11447.00, NULL, 0, NULL, NULL),
(25, 'PASTA ESMALTE AMARILLO', 'PAS025', 0, 2, '100 KU', '5,55', '', 'STD', NULL, NULL, NULL, '>7H', '-', 'STD', NULL, 12718.00, NULL, 0, NULL, NULL),
(26, 'PASTA ESMALTE CAOBA', 'PAS026', 2, 2, '100 KU', '5,55', '', 'STD', NULL, NULL, NULL, '>7H', '-', 'STD', NULL, 7742.00, NULL, 0, NULL, NULL),
(27, 'PASTA ESMALTE AMARILLO OXIDO', 'PAS027', 2, 2, '100 KU', '5,55', '', 'STD', NULL, NULL, NULL, '>7H', '-', 'STD', NULL, 11447.00, NULL, 0, NULL, NULL),
(28, 'PASTA ESMALTE ROJO OXIDO', 'PAS028', 0, 2, '100 KU', '5,55', '', 'STD', NULL, NULL, NULL, '>7H', '-', 'STD', NULL, 1690.00, NULL, 0, NULL, NULL),
(29, 'PASTA ESMALTE BLANCO', 'PAS029', 0, 2, '120', '5,78', '', 'STD', NULL, NULL, NULL, '7,5', '-', '100 +/- 0.5 %', NULL, 10303.00, NULL, 0, NULL, NULL),
(30, 'PASTA ESMALTE TABACO', 'PAS030', 2, 2, '95-100', '5.71-5.91', '', 'STD', NULL, NULL, NULL, '7,5', '-', 'STD', NULL, 722.00, NULL, 0, NULL, NULL),
(31, 'RESINA MEDIA EN SOYA AL 50%', 'RAM014', 1, 0, '', '', '', '', '', '', '', '', '', '', 0, 715.00, NULL, 0, NULL, NULL),
(32, 'METIL ETIL CETOXIMA', 'AAN002', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4300.00, NULL, 0, NULL, NULL),
(33, 'OCTOATO DE COBALTO AL 12%', 'SOC011', 1, 0, '', '', '', '', '', '', '', '', '', '', 0, 4400.00, NULL, 0, NULL, NULL),
(34, 'OCTOATO DE ZIRCONIO AL 24%', 'SOZ024', 1, 0, '', '', '', '', '', '', '', '', '', '', 0, 8000.00, NULL, 0, NULL, NULL),
(35, 'OCTOATO DE CALCIO AL 10%', 'SOC010', 1, 0, '', '', '', '', '', '', '', '', '', '', 0, 8000.00, NULL, 0, NULL, NULL),
(36, 'DISOLVENTE 2232 #3', 'SAA011', 1, 0, '', '', '', '', '', '', '', '', '', '', 0, 1103.00, NULL, 0, NULL, NULL),
(37, 'DIOXIDO DE TITANIO', 'PED010', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22700.00, NULL, 0, NULL, NULL),
(38, 'OCTOATO DE ZINC AL 16%', 'SOZ016', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 43900.00, NULL, 0, NULL, NULL),
(39, 'BENTOCLAY BP 184', 'AAS005', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 37300.00, NULL, 0, NULL, NULL),
(40, 'ETANOL AL 96%', 'SAA022', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22700.00, NULL, 0, NULL, NULL),
(41, 'DISASTAB', 'AEM005', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7000.00, NULL, 0, NULL, NULL),
(42, 'AGUA', 'SIA040', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 19500.00, NULL, 0, NULL, NULL),
(43, 'SULFATO DE MAGNESIO', 'AET004', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 33500.00, NULL, 0, NULL, NULL),
(44, 'VARSOL', 'SAV010', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 37200.00, NULL, 0, NULL, NULL),
(47, '[DUP->59] MICROTALC C 20', 'CTA011', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8000.00, NULL, 0, NULL, '2026-05-30 14:45:21'),
(48, 'CELITE 499', 'MSI006', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11466.00, NULL, 0, NULL, NULL),
(50, 'PASTA ESMALTE ROJO 57:1', 'PE1033', 2, 2, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 17000.00, NULL, 0, NULL, NULL),
(52, 'PASTA AMARILLO CROMO MEDIO', 'PE1010', 2, 2, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 17000.00, NULL, 0, NULL, NULL),
(54, 'PASTA VERDE FTALO', 'PE1040', 2, 2, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4617.00, NULL, 0, NULL, NULL),
(56, 'PASTA ESMALTE AZUL FTALO 15:3', 'PE1021', 2, 2, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22700.00, NULL, 0, NULL, NULL),
(57, 'OMYACARB UF', 'CCC002', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11000.00, NULL, 0, NULL, NULL),
(59, 'MICROTALC C 20', 'CTA025', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(60, 'CARBONATO DE CALCIO HI WHITE', 'CCC004', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(61, 'LECITINA DE SOYA', 'AHU002', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(62, '[DUP->40] ETANOL AL 96%', 'SAM023', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, '2026-05-30 14:45:21'),
(63, 'OXIDO DE HIERRO AMARILLO Y 4021', 'PEA010', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(64, 'OXIDO DE HIERRO ROJO R-5530', 'PER030', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(65, 'MICROTALC 20', 'CTA020', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(66, 'TROYSPERSE CD1', 'ADI002', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(67, 'PIGMENTO VERDE FTALO 7', 'PEV053', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(68, 'PIGMENTO AZUL FTALO 15;3', 'PEA041', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(69, 'EDAPLAN 918 / LANSPERSE SUV', 'ADI010', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(71, 'POW CARBON BLACK CHEMO', 'PEN081', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(72, 'PIGMENTO ROJO CARMIN 57:1', 'PER031', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(73, 'PIGMENTO NARANJA MOLIBDENO', 'PEN023', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(74, 'PIGMENTO MARILLO DE CROMO AL 73', 'PEA011', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(75, 'PIGMENTO OXIFERR CAOBA MARRON M 4781', 'PEC081', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(76, 'PIGMENTO OXIFERR AMARILLO Y-4011', 'PEA013', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(77, 'DIOXIDO DE TITANIO SULFATO 2196', 'PED007', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(78, 'OXIFER TABACO R-4370', 'PET080', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8105.00, NULL, 0, NULL, NULL),
(79, '[DUP->39] BENTOCLAY BP 184', 'AAS012', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, '2026-05-30 14:45:21'),
(80, 'METANOL', 'SAM023', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(81, 'ORGANOCLAY BK 884', 'AAS005', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(83, 'DISOLVENTE 2232 / VARSOL', 'SAA011', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(84, 'EDAPLAN 915', 'ADI010', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(85, 'CHEMOSPERSE 77', 'ADI011', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(86, 'ADIMON 84', 'AAN002', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(87, 'DISOLVENTE #3', 'SAA011', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4372.00, NULL, 0, NULL, NULL),
(88, 'ETANOL 96%', 'SAA022', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4400.00, NULL, 0, NULL, NULL),
(89, 'DISOLVENTE 2232', 'SAA011', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4372.00, NULL, 0, NULL, NULL),
(90, 'DISOLVENTE 3', 'SAA011', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4372.00, NULL, 0, NULL, NULL),
(92, 'OCTOATO DE ZINC 16%', 'SOZ016', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 16300.00, NULL, 0, NULL, NULL),
(93, 'PASTA ESMALTE AMARILLO CROMO MEDIO', 'PE1010', 2, 2, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 14152.00, NULL, 0, NULL, NULL),
(94, '[DUP->77] DIOXIDO DE TITANIO SULFATO 2196', 'PED010', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11466.00, NULL, 0, NULL, '2026-05-30 14:45:21'),
(95, 'BENTOCLAY BP184', 'AAS005', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 17000.00, NULL, 0, NULL, NULL),
(96, 'PASTA ESMALTE AZUL 15:3', 'PE1021', 2, 2, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11447.00, NULL, 0, NULL, NULL),
(97, 'EDAPLAN 918', 'ADI010', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22700.00, NULL, 0, NULL, NULL),
(98, '[DUP->97] EDAPLAN 918 / LANSPERSE SUV', 'ADI010', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22700.00, NULL, 0, NULL, '2026-05-30 14:54:46'),
(99, '[DUP->85] CHEMOSPERSE 77', 'ADI010', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 22700.00, NULL, 0, NULL, '2026-05-30 14:45:21'),
(100, 'PIGMENTO OXIFERR ROJO R-5530', 'PER030', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(133, 'VINILO T1 BLANCO', 'EBT012', 0, 1, '', '', '', '', '', '', '', '', '', '', NULL, 1.00, NULL, 0, NULL, NULL),
(134, 'SIKA WT-100 CO', 'SIK001', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(135, 'POLASTOCRETE', 'SIK002', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(136, 'SIKA STABILIZER 4R CO', 'SIK003', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(137, 'SIKALASTIC 851 R COMP A', 'SIK004', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(138, 'PLASTIMENT TM 5-CO', 'SIK005', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(139, 'SARNACOL 2130', 'SIK006', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(140, 'SIKAFUND MO-CO', 'SIK007', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(141, 'RESINA ACRILICA MASFLEX', 'RES001', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(142, 'UFI PRETHOX', 'VAR001', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(143, 'RESINA NEGRA (POR IDENTIFICAR)', 'RES002', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(144, 'PASTA AZUL PHILAC', 'PHI001', 2, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(145, 'ADITIVO NEGRO (MUESTRA)', 'VAR002', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(146, 'SOLVENTE (POR IDENTIFICAR)', 'SAA099', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(147, 'PROPIL MORENO', 'VAR003', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(148, 'SILVACOL', 'VAR004', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(149, 'HORNESABE BLANCO', 'HOR001', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(150, 'HORNESABE BEIGE', 'HOR002', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(151, 'HORNESABE ALEMANA', 'HOR003', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(152, 'HORNESABE AMARILLO', 'HOR004', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(153, 'SIKA FLOR CURATHANE', 'SIK008', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(154, 'CAT PU', 'VAR005', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(155, 'SIKALASTIC 871 R COMP B', 'SIK009', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(156, 'LODO EPOXÍCO / RESINA EN POLVO', 'VAR006', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(157, 'CAT SKAUR 32', 'VAR007', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(158, 'PU VDE', 'VAR008', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(159, 'RESINAS FERROBAR 903', 'RES003', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(160, 'SIKALASTIC 830 COMP B', 'SIK010', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(161, 'ETHYL SILICATO', 'VAR009', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(162, 'RESINA CORTA R4', 'RES004', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(163, 'RESINA PU', 'RES005', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(164, 'PASTA ROJA PHILAC', 'PHI002', 2, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(165, 'PINTURA NEGRA COOKROT', 'VAR010', 0, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(166, 'XLOC PHILAC SOLVENTE', 'PHI003', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(167, 'SIKA PLAY 169', 'SIK011', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(168, 'SIKA FLUID 169', 'SIK012', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(169, 'SIKAMANTO FLEX COMP A', 'SIK013', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(170, 'LATEX PESANTE PARA TEJAS', 'VAR011', 0, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(171, 'PASTA CAOBA PHILAC', 'PHI004', 2, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(172, 'HORNESABE BCO', 'HOR005', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(173, 'GROUP MORENO', 'VAR012', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(174, 'SOLVENTE SUCIO SIKA', 'SIK014', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(175, 'PROPILER RESINA COMP B', 'RES006', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(176, 'SELLADOR NITRO', 'VAR013', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(177, 'BINDA POLIURETANO', 'VAR014', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(178, 'VINILO BEIGE', 'VAR015', 0, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(179, 'RESINA BEA EPOXICA', 'RES007', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(180, 'FRUTA ROJA', 'PHI005', 2, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(181, 'RESINA BLANCA', 'RES008', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(182, 'RESINA NARANJA', 'RES009', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(183, 'MAFA LACA', 'VAR016', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(184, 'SIKAPLAST REVOLVER CON AMOLRED', 'SIK015', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(185, 'PASTA AMARILLA PHILAC', 'PHI006', 2, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(186, 'ALCONA CATANAS', 'VAR017', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(187, 'SODA PH CONEXA AZL', 'VAR018', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(188, 'CANALINOSE IBC', 'VAR019', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(189, 'RESINA SIKA (MUESTRA)', 'SIK022', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(190, 'INJEX HORENEM ADECRIL', 'VAR028', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(191, 'CODO EPOXÍCO SIKA', 'VAR029', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(192, 'NEGRO - NARANJA (POR IDENTIFICAR)', 'VAR031', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(193, 'RASPER BASE BESS', 'VAR032', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(194, 'ROJO IBC MASFLEX', 'VAR030', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(195, 'EPOXICA (POR IDENTIFICAR)', 'VAR020', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(196, 'PASTA AZUL CON GENA MORENO', 'PHI007', 2, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(197, 'HORNESABE DORADO', 'HOR006', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(198, 'HORNESABE DORADO COBRE', 'HOR007', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(199, 'HORNESABE VERDE ALBOA', 'HOR008', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(200, 'HORNESABE AMARILLA', 'HOR009', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(201, 'SPLANDER PHILAC', 'PHI008', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(202, 'MICA INTERIOR PHILAC', 'PHI009', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(203, 'PASTA MORADA CARVAJAL PHILAC', 'PHI010', 2, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(204, 'PASTA VIOLETA', 'PHI011', 2, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(205, 'GPS SIKA (MUESTRA)', 'SIK016', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(206, 'XLOC PHILAC (POR ANALIZAR)', 'PHI012', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(207, 'ANT BES AREPHE', 'VAR021', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(208, 'MOLOC NARANJA', 'VAR022', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(209, 'PASTA AZUL (TAMBOR LOP)', 'PHI013', 2, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(210, 'POLIESTER POP LUCY', 'VAR023', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(211, 'CAT EPOXÍCO IBC', 'VAR024', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(212, 'VINILO POP COLONIAL', 'VAR025', 0, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(213, 'TAMBOR AMARILLO SIKA (POR IDENTIFICAR)', 'SIK023', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(214, 'SIKAPLAST REVOLVER', 'SIK017', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(215, 'SIKA FULL REVOLVER', 'SIK018', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(216, 'SIKA FILM', 'SIK019', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(217, 'SIKA TRAFIC COMP A', 'SIK020', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(218, 'MANCHA (COLORANTE)', 'PHI014', 2, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(219, 'SPLANDER', 'VAR026', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(220, 'LACANTE', 'VAR027', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(221, 'SOLVENTE CON BORNELO', 'SAA030', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(222, '2N SIKA STABILIZER 100', 'SIK021', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, 0, 1, NULL),
(223, 'BARNIZ EPOXICO ', 'EP01', 0, 4, '', '', '', '', '', '', '', '', '', '', 2, NULL, NULL, 0, NULL, NULL),
(224, 'EPOXICA TRANSPARENTE', 'EPTR91', 0, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 0.00, NULL, 0, NULL, NULL),
(225, 'XILOL', 'XIL21288', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(226, 'RESINA EPOXICA', 'NPSN CHINA', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(230, 'DISPERSANTE', NULL, 2, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5000.00, NULL, 0, 9, NULL),
(231, 'DISPERSANTE', '093816', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 5378.00, NULL, 0, NULL, NULL),
(232, 'CLEYTONE HY', '927163', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 2000.00, NULL, 0, NULL, NULL),
(233, 'AZUL ULTRAMAR', '018273', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 2000.00, NULL, 0, NULL, NULL),
(235, 'CARBONATO UF', '556115', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 20.00, NULL, 0, NULL, NULL),
(236, 'FOSFATO ZINC', '521584', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 1000.00, NULL, 0, NULL, NULL),
(241, 'ANTIPIEL', '545124', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 2000.00, NULL, 0, NULL, NULL),
(242, 'P-400', '545124', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, 2000.00, NULL, 0, NULL, NULL),
(244, 'ISOBUTANOL', NULL, 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(245, 'BUTIL GLICOL', NULL, 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(246, 'TPF', 'MP-246', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(247, 'NONIL TERGITOL', 'MP-247', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(248, 'MECELLOSE', 'MP-248', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(249, 'ANTIESPUMANTE', 'MP-249', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(250, 'DIETILEN GLICOL', 'MP-250', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(251, 'CARBONATO DE CALCIO', 'MP-251', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(252, 'TALCO TY 400', 'MP-252', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(253, 'CAOLIN', 'MP-253', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(254, 'TEXANOL', 'MP-254', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(255, 'ACRONAL', 'MP-255', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(256, 'BACTERICIDA', 'MP-256', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(257, 'AMONIACO', 'MP-257', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(258, 'HISOL ASOCIATIVO', 'MP-258', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(259, 'FUNGICIDA', 'MP-259', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(260, 'ACEITE DE PINO', 'MP-260', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(261, 'BUTIL CELLOSOLVE', 'MP-261', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(262, 'TROYSSOL 366', 'MP-262', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(263, 'POLVO PERLADO VERDOSO', 'MP-263', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(264, 'POLVO PERLADO RICO EN ORO', 'MP-264', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(265, 'RESINA 000', 'MP-265', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(266, 'RESINA MALEICA AL 60%', 'MP-266', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(267, 'PIGMENTO CROMATO DE ZINC', 'MP-267', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(268, 'PIGMENTO ALUMINIO 22 NL', 'MP-268', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(269, 'ACETATO N-PROPILO', 'MP-269', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(270, 'UREA FORMAL', 'MP-270', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(271, 'BYK 066N NIVELANTE', 'MP-271', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(272, 'BYK 108 ANTIESPUMANTE', 'MP-272', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(273, 'PIGMENTO VERDE OXIDO CROMO', 'MP-273', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(274, 'RESINA EPOXICA 100%', 'MP-274', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(275, 'VINILO BLANCO TIPO 2', 'VIN275', 0, 5, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(276, 'VINILO BLANCO TIPO 3', 'VIN276', 0, 5, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(277, 'ESMALTE AZUL REAL', 'ESM277', 0, 1, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(278, 'LACA CATALIZADA BRILLANTE', 'LAC278', 0, 7, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(279, 'PASTA OCRE PARA VINILO', 'PAS279', 2, 2, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(280, 'VINILO OCRE T1', 'VIN280', 0, 5, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(281, 'ESMALTE AMARILLO CATERPILLAR', 'ESM281', 0, 1, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(282, 'ESMALTE NEGRO', 'ESM282', 0, 1, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(283, 'ESMALTE BLANCO T1', 'ESM283', 0, 1, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(284, 'ESMALTE BLANCO 4X1', 'ESM284', 0, 1, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(285, 'ESMALTE BLANCO ECONOMICO J.J', 'ESM285', 0, 1, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(286, 'ESMALTE ECONOMICO BLANCO J.H', 'ESM286', 0, 1, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(287, 'ESMALTE DORADO', 'ESM287', 0, 1, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(288, 'ANTICORROSIVO CROMATO ZN VERDE', 'ANT288', 0, 3, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(289, 'ESMALTE DE ALUMINIO', 'ESM289', 0, 1, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(290, 'EPOXICA BLANCO', 'EPX290', 0, 6, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(291, 'EPOXICA NEGRA', 'EPX291', 0, 6, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(292, 'EPOXICA GRIS', 'EPX292', 0, 6, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(293, 'EPOXICA NEGRA RESINA 100%', 'EPX293', 0, 6, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(294, 'EPOXICA POLIAMIDA VERDE', 'EPX294', 0, 6, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(295, 'EPOXICA AZUL', 'EPX295', 0, 6, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(296, 'EPOXICA ROJO OXIDO', 'EPX296', 0, 6, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(297, 'ESMALTE EPOXI SILICATO BLANCO', 'ESM297', 0, 6, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(298, 'ESMALTE EPOXI SILICATO VERDE', 'ESM298', 0, 6, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(299, 'ESMALTE EPOXICO AMARILLO', 'ESM299', 0, 6, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(300, 'PVA RESIFLEX 610', 'PRE-193781', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 5040.00, NULL, 0, 9, NULL),
(301, 'PVA RESIFLEX F55M', 'PRE-192392', 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7620.00, NULL, 0, 9, NULL),
(302, 'ENDURECEDOR 100%', NULL, 1, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9, NULL),
(334, 'COALESCENTE', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(335, 'ESPESANTE ACRILICO ASOCIATIVO', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(336, 'ESPESANTE CELULOSICO', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(337, 'RESINA ACRILICA EXTERIORES', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(338, 'DISPERSANTE BASE SOLVENTE', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(339, 'NIVELANTE', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(340, 'ANTIESPUMANTE EPOXICOS', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(341, 'AMARILLO CROMO MEDIO', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(342, 'HUMECTANTE BASE AGUA', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(343, 'HIDROFUGANTE MATE', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(344, 'HIDROFUGANTE BRILLANTE', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(345, 'BIOCIDA DA PLUS', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(346, 'BIOCIDA DA ULTRA', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(347, 'OMYACARB 15', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(348, 'OMYACARB 4', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(349, 'TALCO EXTRA', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL),
(350, 'TALCO EXTRA MEJORADO', NULL, 1, 0, NULL, NULL, '1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 9, NULL, NULL, 0, 9, NULL);
...
(385, 31, 180.00, NULL, 42),
(386, 31, 1.60, NULL, 246),
(387, 31, 3.00, NULL, 231),
(388, 31, 2.50, NULL, 247),
(389, 31, 2.50, NULL, 248),
(390, 31, 2.00, NULL, 249),
(391, 31, 10.00, NULL, 250),
(392, 31, 95.00, NULL, 37),
(393, 31, 200.00, NULL, 251),
(394, 31, 60.00, NULL, 252),
(395, 31, 80.00, NULL, 253),
(396, 31, 80.00, NULL, 235),
(397, 31, 5.00, NULL, 254),
(398, 31, 170.00, NULL, 255),
(399, 31, 4.00, NULL, 256),
(400, 31, 3.00, NULL, 249),
(401, 31, 127.00, NULL, 42),
(402, 31, 4.00, NULL, 257),
(403, 31, 3.00, NULL, 248),
(404, 31, 1.50, NULL, 258),
(405, 31, 2.00, NULL, 259),
(406, 31, 0.40, NULL, 260),
(407, 32, 100.00, NULL, 226),
(408, 32, 30.00, NULL, 225),
(409, 32, 20.00, NULL, 244),
(410, 32, 10.00, NULL, 142),
(411, 32, 5.00, NULL, 261),
(412, 32, 10.00, NULL, 269),
(413, 33, 0.00, NULL, 42),
(414, 33, 1.50, NULL, 246),
(415, 33, 2.00, NULL, 231),
(416, 33, 2.00, NULL, 248),
(417, 33, 2.60, NULL, 247),
(418, 33, 5.00, NULL, 250),
(419, 33, 2.50, NULL, 254),
(420, 33, 2.00, NULL, 249),
(421, 33, 35.00, NULL, 37),
(422, 33, 400.00, NULL, 251),
(423, 33, 50.00, NULL, 252),
(424, 33, 50.00, NULL, 253),
(425, 33, 80.00, NULL, 255),
(426, 33, 2.00, NULL, 249),
(427, 33, 4.00, NULL, 257),
(428, 33, 4.00, NULL, 248),
(429, 33, 4.00, NULL, 256),
(430, 33, 3.30, NULL, 258),
(431, 33, 0.40, NULL, 260),
(432, 34, 1.00, NULL, 42),
(433, 34, 1.40, NULL, 246),
(434, 34, 2.20, NULL, 231),
(435, 34, 2.00, NULL, 247),
(436, 34, 10.00, NULL, 248),
(437, 34, 60.00, NULL, 37),
(438, 34, 425.00, NULL, 252),
(439, 34, 10.00, NULL, 251),
(440, 34, 3.00, NULL, 253),
(441, 34, 36.00, NULL, 250),
(442, 34, 2.40, NULL, 255),
(443, 34, 2.00, NULL, 256),
(444, 34, 4.00, NULL, 249),
(445, 34, 2.50, NULL, 248),
(446, 34, 4.00, NULL, 257),
(447, 34, 4.00, NULL, 258),
(448, 34, 0.40, NULL, 260),
(449, 35, 180.00, NULL, 31),
(450, 35, 2.00, NULL, 232),
(451, 35, 1.00, NULL, 231),
(452, 35, 130.00, NULL, 44),
(453, 35, 3.00, NULL, 235),
(454, 35, 30.00, NULL, 56),
(455, 35, 2.00, NULL, 37),
(456, 35, 1.50, NULL, 236),
(457, 35, 1.00, NULL, 33),
(458, 35, 1.00, NULL, 35),
(459, 35, 1.00, NULL, 34),
(460, 35, 0.40, NULL, 32),
(461, 35, 0.30, NULL, 242),
(462, 36, 60.00, NULL, 162),
(463, 36, 40.00, NULL, 142),
(464, 36, 55.00, NULL, 225),
(465, 36, 2.50, NULL, 261),
(466, 36, 12.00, NULL, 244),
(467, 36, 0.30, NULL, 262),
(468, 37, 40.00, NULL, 42),
(469, 37, 2.00, NULL, 247),
(470, 37, 0.50, NULL, 246),
(471, 37, 1.50, NULL, 256),
(472, 37, 1.50, NULL, 231),
(473, 37, 40.00, NULL, 63),
(474, 37, 15.00, NULL, 250),
(475, 37, 2.00, NULL, 249),
(476, 37, 1.20, NULL, 248),
(477, 37, 0.30, NULL, 258),
(478, 38, 80.00, NULL, 42),
(479, 38, 0.70, NULL, 231),
(480, 38, 1.20, NULL, 249),
(481, 38, 0.60, NULL, 247),
(482, 38, 0.60, NULL, 246),
(483, 38, 1.00, NULL, 248),
(484, 38, 18.00, NULL, 63),
(485, 38, 40.00, NULL, 252),
(486, 38, 15.00, NULL, 251),
(487, 38, 40.00, NULL, 255),
(488, 38, 2.10, NULL, 250),
(489, 38, 0.70, NULL, 254),
(490, 38, 1.00, NULL, 256),
(491, 38, 0.90, NULL, 257),
(492, 38, 0.60, NULL, 248),
(493, 38, 0.40, NULL, 260),
(494, 38, 0.60, NULL, 249),
(495, 38, 1.50, NULL, 258),
(496, 39, 60.00, NULL, 31),
(497, 39, 0.50, NULL, 231),
(498, 39, 1.00, NULL, 232),
(499, 39, 22.00, NULL, 63),
(500, 39, 10.00, NULL, 44),
(501, 39, 1.00, NULL, 236),
(502, 39, 40.00, NULL, 31),
(503, 39, 35.00, NULL, 44),
(504, 39, 1.00, NULL, 33),
(505, 39, 1.20, NULL, 34),
(506, 39, 1.00, NULL, 35),
(507, 39, 0.40, NULL, 241),
(508, 39, 0.20, NULL, 242),
(509, 40, 180.00, NULL, 31),
(510, 40, 0.50, NULL, 231),
(511, 40, 1.50, NULL, 232),
(512, 40, 30.00, NULL, 22),
(513, 40, 30.00, NULL, 44),
(514, 40, 1.00, NULL, 236),
(515, 40, 0.50, NULL, 41),
(516, 40, 24.00, NULL, 42),
(517, 40, 1.20, NULL, 35),
(518, 40, 1.00, NULL, 33),
(519, 40, 1.30, NULL, 34),
(520, 40, 0.80, NULL, 32),
(521, 40, 0.20, NULL, 242),
(522, 40, 5.00, NULL, 44),
(523, 41, 180.00, NULL, 31),
(524, 41, 2.00, NULL, 231),
(525, 41, 5.00, NULL, 232),
(526, 41, 0.28, NULL, 233),
(527, 41, 25.00, NULL, 235),
(528, 41, 100.00, NULL, 37),
(529, 41, 5.00, NULL, 236),
(530, 41, 30.00, NULL, 44),
(531, 41, 200.00, NULL, 31),
(532, 41, 185.00, NULL, 44),
(533, 41, 2.50, NULL, 33),
(534, 41, 3.00, NULL, 35),
(535, 41, 3.50, NULL, 34),
(536, 41, 1.80, NULL, 241),
(537, 41, 0.40, NULL, 242),
(538, 42, 80.00, NULL, 31),
(539, 42, 1.50, NULL, 232),
(540, 42, 0.50, NULL, 231),
(541, 42, 5.00, NULL, 44),
(542, 42, 35.00, NULL, 37),
(543, 42, 6.00, NULL, 236),
(544, 42, 6.00, NULL, 235),
(545, 42, 40.00, NULL, 44),
(546, 42, 10.00, NULL, 31),
(547, 42, 0.90, NULL, 35),
(548, 42, 0.80, NULL, 33),
(549, 42, 0.85, NULL, 34),
(550, 42, 0.40, NULL, 241),
(551, 42, 0.50, NULL, 242),
(552, 42, 0.10, NULL, 204),
(553, 43, 40.00, NULL, 31),
(554, 43, 0.20, NULL, 231),
(555, 43, 0.70, NULL, 232),
(556, 43, 0.09, NULL, 233),
(557, 43, 9.00, NULL, 37),
(558, 43, 1.90, NULL, 251),
(559, 43, 6.00, NULL, 44),
(560, 43, 0.30, NULL, 41),
(561, 43, 11.00, NULL, 42),
(562, 43, 17.50, NULL, 44),
(563, 43, 0.25, NULL, 33),
(564, 43, 0.35, NULL, 35),
(565, 43, 0.40, NULL, 34),
(566, 43, 0.25, NULL, 241),
(567, 44, 46.00, NULL, 31),
(568, 44, 0.20, NULL, 231),
(569, 44, 0.60, NULL, 232),
(570, 44, 0.09, NULL, 233),
(571, 44, 10.20, NULL, 37),
(572, 44, 7.00, NULL, 44),
(573, 44, 0.50, NULL, 41),
(574, 44, 16.00, NULL, 42),
(575, 44, 7.00, NULL, 44),
(576, 44, 0.32, NULL, 33),
(577, 44, 0.50, NULL, 35),
(578, 44, 0.50, NULL, 34),
(579, 44, 0.20, NULL, 241),
(580, 45, 105.00, NULL, 31),
(581, 45, 1.60, NULL, 232),
(582, 45, 39.00, NULL, 44),
(583, 45, 1.40, NULL, 33),
(584, 45, 1.60, NULL, 34),
(585, 45, 1.50, NULL, 35),
(586, 45, 6.40, NULL, 263),
(587, 45, 1.60, NULL, 264),
(588, 45, 0.50, NULL, 241),
(589, 46, 35.00, NULL, 265),
(590, 46, 1.20, NULL, 232),
(591, 46, 0.50, NULL, 231),
(592, 46, 6.50, NULL, 37),
(593, 46, 25.00, NULL, 267),
(594, 46, 4.00, NULL, 63),
(595, 46, 38.00, NULL, 252),
(596, 46, 38.00, NULL, 251),
(597, 46, 20.00, NULL, 225),
(598, 46, 15.00, NULL, 266),
(599, 46, 3.00, NULL, 244),
(600, 46, 50.00, NULL, 265),
(601, 46, 0.50, NULL, 33),
(602, 46, 0.60, NULL, 35),
(603, 46, 0.50, NULL, 34),
(604, 46, 0.60, NULL, 22),
(605, 46, 1.20, NULL, 56),
(606, 46, 30.00, NULL, 225),
(607, 47, 210.00, NULL, 31),
(608, 47, 1.40, NULL, 232),
(609, 47, 0.75, NULL, 231),
(610, 47, 2.90, NULL, 244),
(611, 47, 28.00, NULL, 268),
(612, 47, 69.00, NULL, 44),
(613, 47, 2.50, NULL, 35),
(614, 47, 2.60, NULL, 34),
(615, 47, 1.20, NULL, 33),
(616, 47, 1.00, NULL, 241),
(617, 48, 120.00, NULL, 226),
(618, 48, 1.50, NULL, 231),
(619, 48, 25.00, NULL, 225),
(620, 48, 2.00, NULL, 232),
(621, 48, 3.00, NULL, 236),
(622, 48, 78.00, NULL, 37),
(623, 48, 150.00, NULL, 252),
(624, 48, 40.00, NULL, 226),
(625, 48, 25.00, NULL, 225),
(626, 48, 50.00, NULL, 235),
(627, 48, 4.50, NULL, 245),
(628, 48, 1.00, NULL, 270),
(629, 48, 18.00, NULL, 244),
(630, 48, 10.00, NULL, 161),
(631, 49, 60.00, NULL, 226),
(632, 49, 1.00, NULL, 231),
(633, 49, 1.30, NULL, 232),
(634, 49, 2.50, NULL, 236),
(635, 49, 10.00, NULL, 225),
(636, 49, 80.00, NULL, 252),
(637, 49, 8.00, NULL, 251),
(638, 49, 32.00, NULL, 22),
(639, 49, 20.00, NULL, 226),
(640, 49, 9.00, NULL, 244),
(641, 49, 7.60, NULL, 142),
(642, 49, 8.00, NULL, 269),
(643, 49, 14.00, NULL, 225),
(644, 49, 1.00, NULL, 261),
(645, 50, 100.00, NULL, 226),
(646, 50, 5.00, NULL, 232),
(647, 50, 1.50, NULL, 231),
(648, 50, 15.00, NULL, 225),
(649, 50, 4.00, NULL, 236),
(650, 50, 68.00, NULL, 37),
(651, 50, 50.00, NULL, 251),
(652, 50, 165.00, NULL, 252),
(653, 50, 2.40, NULL, 261),
(654, 50, 60.00, NULL, 226),
(655, 50, 15.00, NULL, 244),
(656, 50, 3.00, NULL, 22),
(657, 50, 10.00, NULL, 142),
(658, 50, 8.00, NULL, 269),
(659, 50, 30.00, NULL, 225),
(660, 51, 100.00, NULL, 274),
(661, 51, 0.80, NULL, 231),
(662, 51, 1.80, NULL, 232),
(663, 51, 2.20, NULL, 236),
(664, 51, 2.00, NULL, 225),
(665, 51, 70.00, NULL, 252),
(666, 51, 8.00, NULL, 251),
(667, 51, 5.00, NULL, 244),
(668, 51, 4.00, NULL, 269),
(669, 51, 1.00, NULL, 261),
(670, 51, 32.00, NULL, 22),
(671, 52, 76.30, NULL, 226),
(672, 52, 1.40, NULL, 231),
(673, 52, 5.00, NULL, 232),
(674, 52, 20.00, NULL, 225),
(675, 52, 3.80, NULL, 37),
(676, 52, 16.00, NULL, 252),
(677, 52, 10.00, NULL, 236),
(678, 52, 100.00, NULL, 251),
(679, 52, 17.50, NULL, 63),
(680, 52, 5.00, NULL, 261),
(681, 52, 26.00, NULL, 225),
(682, 52, 1.90, NULL, 56),
(683, 53, 13.00, NULL, 226),
(684, 53, 0.25, NULL, 231),
(685, 53, 0.75, NULL, 232),
(686, 53, 12.00, NULL, 56),
(687, 53, 22.00, NULL, 226),
(688, 53, 2.00, NULL, 225),
(689, 53, 2.00, NULL, 142),
(690, 53, 3.00, NULL, 244),
(691, 53, 1.50, NULL, 261),
(692, 53, 3.50, NULL, 225),
(693, 53, 0.05, NULL, 271),
(694, 53, 0.23, NULL, 272),
(695, 53, 4.00, NULL, 252),
(696, 53, 20.00, NULL, 251),
(697, 54, 120.00, NULL, 226),
(698, 54, 2.00, NULL, 272),
(699, 54, 2.50, NULL, 232),
(700, 54, 22.00, NULL, 225),
(701, 54, 40.00, NULL, 64),
(702, 54, 2.00, NULL, 236),
(703, 54, 100.00, NULL, 252),
(704, 54, 8.00, NULL, 261),
(705, 54, 50.00, NULL, 251),
(706, 54, 40.00, NULL, 226),
(707, 54, 28.00, NULL, 244),
(708, 54, 1.50, NULL, 270),
(709, 54, 16.00, NULL, 269),
(710, 54, 20.00, NULL, 225),
(711, 55, 5.00, NULL, 226),
(712, 55, 0.25, NULL, 231),
(713, 55, 0.20, NULL, 232),
(714, 55, 2.90, NULL, 37),
(715, 55, 0.50, NULL, 236),
(716, 55, 0.50, NULL, 225),
(717, 55, 11.30, NULL, 161),
(718, 56, 4.00, NULL, 226),
(719, 56, 0.16, NULL, 232),
(720, 56, 0.20, NULL, 231),
(721, 56, 0.40, NULL, 273),
(722, 56, 0.20, NULL, 37),
(723, 56, 1.20, NULL, 63),
(724, 56, 0.80, NULL, 225),
(725, 56, 9.20, NULL, 161),
(726, 57, 55.00, NULL, 226),
(727, 57, 20.00, NULL, 225),
(728, 57, 1.50, NULL, 232),
(729, 57, 1.50, NULL, 231),
(730, 57, 0.50, NULL, 63),
(731, 57, 28.00, NULL, 74),
(732, 57, 34.00, NULL, 226),
(733, 57, 3.00, NULL, 261),
(734, 57, 15.00, NULL, 244),
(735, 57, 8.00, NULL, 270),
(736, 57, 0.50, NULL, 262),
(737, 1, 115.00, NULL, 31),
(738, 1, 66.00, NULL, 44),
(739, 1, 1.30, NULL, 33),
(740, 1, 1.30, NULL, 34),
(741, 1, 1.60, NULL, 35),
(742, 1, 0.50, NULL, 241),
(743, 2, 180.00, NULL, 31),
(744, 2, 2.00, NULL, 231),
(745, 2, 5.00, NULL, 232),
(746, 2, 0.28, NULL, 233),
(747, 2, 180.00, NULL, 37),
(748, 2, 20.00, NULL, 235),
(749, 2, 3.00, NULL, 236),
(750, 2, 0.00, NULL, 44),
(751, 2, 180.00, NULL, 31),
(752, 2, 15.00, NULL, 44),
(753, 2, 2.00, NULL, 41),
(754, 2, 0.00, NULL, 42),
(755, 2, 2.00, NULL, 33),
...
(767, 5, 1.20, NULL, 35),
(768, 5, 0.80, NULL, 32),
(769, 11, 100.00, NULL, 31),
(770, 11, 16.00, NULL, 74),
(771, 11, 1.00, NULL, 232),
(772, 11, 0.50, NULL, 231),
(773, 11, 0.75, NULL, 236),
(774, 11, 10.00, NULL, 44),
(775, 11, 1.00, NULL, 235),
(776, 11, 25.00, NULL, 44),
(777, 11, 0.50, NULL, 41),
(778, 11, 15.00, NULL, 42),
(779, 11, 0.50, NULL, 33),
(780, 11, 0.50, NULL, 34),
(781, 11, 0.50, NULL, 35),
(782, 11, 0.40, NULL, 241),
(783, 14, 160.00, NULL, 31),
(784, 14, 1.50, NULL, 232),
(785, 14, 1.00, NULL, 231),
(786, 14, 35.00, NULL, 44),
(787, 14, 20.00, NULL, 37),
(788, 14, 1.50, NULL, 236),
(789, 14, 120.00, NULL, 252),
(790, 14, 35.00, NULL, 44),
(791, 14, 1.00, NULL, 41),
(792, 14, 65.00, NULL, 42),
(793, 14, 0.50, NULL, 22),
(794, 14, 1.00, NULL, 35),
(795, 14, 0.80, NULL, 34),
(796, 14, 0.50, NULL, 33),
(797, 14, 0.40, NULL, 241),
(798, 15, 210.00, NULL, 31),
(799, 15, 1.50, NULL, 232),
(800, 15, 0.60, NULL, 231),
(801, 15, 15.00, NULL, 44),
(802, 15, 1.50, NULL, 236),
(803, 15, 130.00, NULL, 252),
(804, 15, 38.00, NULL, 22),
(805, 15, 0.80, NULL, 33),
(806, 15, 1.00, NULL, 34),
(807, 15, 1.00, NULL, 35),
(808, 15, 45.00, NULL, 44),
(809, 15, 0.80, NULL, 241),
(810, 18, 160.00, NULL, 31),
(811, 18, 1.50, NULL, 232),
(812, 18, 1.00, NULL, 231),
(813, 18, 1.50, NULL, 236),
(814, 18, 30.00, NULL, 44),
(815, 18, 60.00, NULL, 252),
(816, 18, 25.00, NULL, 37),
(817, 18, 50.00, NULL, 251),
(818, 18, 55.00, NULL, 44),
(819, 18, 1.00, NULL, 41),
(820, 18, 52.00, NULL, 42),
(821, 18, 1.00, NULL, 35),
(822, 18, 1.20, NULL, 34),
(823, 18, 0.80, NULL, 33),
(824, 18, 0.80, NULL, 241),
(825, 19, 95.00, NULL, 31),
(826, 19, 0.80, NULL, 232),
(827, 19, 0.30, NULL, 231),
(828, 19, 5.00, NULL, 63),
(829, 19, 1.00, NULL, 37),
(830, 19, 66.00, NULL, 252),
(831, 19, 33.00, NULL, 251),
(832, 19, 10.00, NULL, 44),
(833, 19, 1.00, NULL, 56),
(834, 19, 0.50, NULL, 35),
(835, 19, 0.40, NULL, 33),
(836, 19, 0.60, NULL, 34),
(837, 19, 0.40, NULL, 241);
...
INSERT INTO `item_proveedor` (`id_item_proveedor`, `nombre`, `codigo`, `tipo`, `precio_unitario`, `precio_con_iva`, `disponible`, `descripcion`, `proveedor_id`, `item_general_id`, `unidad_compra_id`, `factor_conversion`, `deleted_at`) VALUES
(40, 'TALCO TY 400 G', 'QUI-MAT-0001', 'Materia Prima', 1504.00, 1790.00, 1, NULL, 23, NULL, NULL, 1.000000, NULL),
(41, 'OMIYACARB UF', 'QUI-MAT-0002', 'Materia Prima', 1828.00, 2175.00, 1, NULL, 23, NULL, NULL, 1.000000, NULL),
(42, 'COLARDIT ANTIESPUMANTE', 'QUI-ADIT-0001', 'Insumo', 7143.00, 8500.00, 1, NULL, 23, NULL, NULL, 1.000000, NULL),
(43, 'COLARCRYL ACRONAL 50', 'QUI-ADIT-0002', 'Insumo', 5252.00, 6250.00, 1, NULL, 23, NULL, NULL, 1.000000, NULL),
(44, 'COLARCIDE BACTERICIDA', 'QUI-BIO-0001', 'Insumo', 6387.00, 7600.00, 1, NULL, 23, NULL, NULL, 1.000000, NULL),
(45, 'COLARDIT REGULADOR PH', 'QUI-ADIT-0003', 'Insumo', 6555.00, 7800.00, 1, NULL, 23, NULL, NULL, 1.000000, NULL),
(46, 'DISPERSANTE', 'QUI-ADIT-0004', 'Insumo', 5378.00, 6400.00, 1, '', 23, 230, NULL, 1.000000, NULL),
(47, 'COLARDIT AS ASOCIATIVO', 'QUI-ADIT-0005', 'Insumo', 9916.00, 11800.00, 1, NULL, 23, NULL, NULL, 1.000000, NULL),
(48, 'COLARBAG FUNGICIDA', 'QUI-BIO-0002', 'Insumo', 20840.00, 24800.00, 1, NULL, 23, NULL, NULL, 1.000000, NULL),
(49, 'BRITEX CALCINADO', 'QUI-MAT-0003', 'Materia Prima', 2605.00, 3100.00, 1, NULL, 23, NULL, NULL, 1.000000, NULL),
(50, 'WEKCELO C7 CELULOSICO', 'QUI-ESP-0001', 'Insumo', 18403.00, 21900.00, 1, NULL, 23, NULL, NULL, 1.000000, NULL),
(51, 'CARBONATO DE CALCIO M325', 'CARBM325', 'Materia Prima', 300.00, 357.00, 1, '', 24, NULL, 9, 1.000000, NULL),
(52, 'CARBONATO DE CALCIO M600', 'CARBM600', 'Materia Prima', 460.00, 547.00, 1, '', 24, NULL, 9, 1.000000, NULL),
(53, 'RESINA EPOXICA', 'NPSN CHINA', 'Materia Prima', 15069.00, 17932.00, 1, '', 25, 226, 9, 1.000000, NULL),
(54, 'RESINA KR 828 100%', 'KER828', 'Materia Prima', 10300.00, 12257.00, 1, '', 26, NULL, 9, 1.000000, NULL),
(55, 'ENDURECEDOR 100%', 'NT-1515X70', 'Materia Prima', 20000.00, 23800.00, 1, '', 26, 302, 9, 1.000000, NULL),
(56, 'ENDURECEDOR 100%', 'NX-5454', 'Materia Prima', 19700.00, 23443.00, 1, '', 26, NULL, 9, 1.000000, NULL),
(57, 'XILOL', 'XIL21288', 'Materia Prima', 6120.00, 7283.00, 1, '', 27, 225, 9, 1.000000, NULL),
(58, 'THINNER ', 'TH2092', 'Materia Prima', 15961.00, 18994.00, 1, '', 27, NULL, 3, 1.000000, NULL),
(59, 'VARSOL', 'VAR9218', 'Materia Prima', 5961.00, 7094.00, 1, '', 27, NULL, NULL, 1.000000, NULL),
(60, 'VARSOL', 'VARPD281', 'Materia Prima', 1230.00, 1464.00, 1, '', 28, NULL, NULL, 1.000000, NULL),
(61, 'THINNER', 'TH921298', 'Materia Prima', 880.00, 1047.00, 1, '', 28, NULL, 3, 1.000000, NULL),
(62, 'RESINA MEDIA EN SOYA AL 50%', 'RA-7', 'Materia Prima', 6200.00, 7378.00, 1, '', 29, NULL, 9, 1.000000, NULL),
(63, 'RESINA UREA FORMALDEHIDO', 'RN-9E', 'Materia Prima', 8050.00, 9580.00, 1, '', 29, NULL, 9, 1.000000, NULL),
(64, 'RESINA CORTA EN PALMISTE AL 55%', 'RA-4 ', 'Materia Prima', 7350.00, 8747.00, 1, '', 29, NULL, 9, 1.000000, NULL),
(65, 'RESINA CORTA EN SOYA AL 53%', 'RA-15', 'Materia Prima', 6900.00, 8211.00, 1, '', 29, NULL, 9, 1.000000, NULL),
(66, 'RESINA CORTA EN SOYA AL 55% (+ SOL)', 'RA-15M', 'Materia Prima', 6900.00, 8211.00, 1, '', 29, NULL, 9, 1.000000, NULL),
(67, 'RESINA CORTA EN SOYA AL 45%', 'RA-16', 'Materia Prima', 6950.00, 8271.00, 1, '', 29, NULL, 9, 1.000000, NULL),
(68, 'RESINA MALEICA SOLIDA', 'RM-1', 'Materia Prima', 11300.00, 13447.00, 1, '', 29, NULL, 9, 1.000000, NULL),
(69, 'RESINA MEDIA EN TOFA AL 50%', 'RA-22', 'Materia Prima', 7550.00, 8985.00, 1, '', 29, NULL, 9, 1.000000, NULL),
(70, 'RESINA MEDIA EN SOYA AL 50%', 'RA-23', 'Materia Prima', 6350.00, 7557.00, 1, '', 29, NULL, 9, 1.000000, NULL),
(71, 'RESINA LARGA EN SOYA AL 70%', 'RA-25', 'Materia Prima', 7300.00, 8687.00, 1, '', 29, NULL, 9, 1.000000, NULL),
(72, 'RESINA CHAIN STOPPED AL 60%', 'RA-37', 'Materia Prima', 7200.00, 8568.00, 1, '', 29, NULL, 9, 1.000000, NULL),
(73, 'RESINA CORTA EN TOFA AL 55%', 'RA-44', 'Materia Prima', 8200.00, 9758.00, 1, '', 29, NULL, 9, 1.000000, NULL),
(74, 'RESINA UREA FORMALDEHIDO', 'RN-9E', 'Materia Prima', 8050.00, 9580.00, 1, '', 29, NULL, 9, 1.000000, NULL),
(75, 'XILOL', 'XILB6800', 'Materia Prima', 5714.29, 6800.00, 1, '', 30, 225, 9, 1.000000, NULL),
(76, 'ISOBUTANOL', 'ISOB7100', 'Materia Prima', 5966.39, 7100.00, 1, '', 30, 244, 9, 1.000000, NULL),
(77, 'Butil Glicol', 'BUTB890', 'Materia Prima', 7478.99, 8900.00, 1, '', 30, 245, 9, 1.000000, NULL),
(78, 'PVA RESIFLEX 610', 'PRE-193781', 'Materia Prima', 5040.00, 5998.00, 1, '', 31, 300, 9, 1.000000, NULL),
(79, 'PVA RESIFLEX F55M', 'PRE-192392', 'Materia Prima', 7620.00, 9068.00, 1, '', 31, 301, 9, 1.000000, NULL),
(80, 'DISPERS PA45', 'PA45', 'Materia Prima', 8500.00, 10115.00, 1, 'Dispersante base agua. Tambor 200 kg', 32, 231, 9, 1.000000, NULL),
(81, 'RWANTA C-12', 'C-12', 'Materia Prima', 10000.00, 11900.00, 1, 'Coalescente. Tambor 200 kg', 32, 334, 9, 1.000000, NULL),
(82, 'AKASIL RE20', 'RE20', 'Materia Prima', 18000.00, 21420.00, 1, 'Antiespumante base agua. Tambor 200 kg', 32, 249, 9, 1.000000, NULL),
(83, 'REOLOG 30', 'REOLOG30', 'Materia Prima', 11500.00, 13685.00, 1, 'Espesante acrilico asociativo. Tambor 200 kg', 32, 335, 9, 1.000000, NULL),
(84, 'HEM 150.000S', 'HEM150000S', 'Materia Prima', 19500.00, 23205.00, 1, 'Espesante celulosico', 32, 336, 9, 1.000000, NULL),
(85, 'FLEX CA50', 'CA50', 'Materia Prima', 6800.00, 8092.00, 1, 'Resina Acrilica para exteriores', 32, 337, 9, 1.000000, NULL),
(86, 'LANSPERSE SUV', 'LANSPERSE', 'Materia Prima', 25000.00, 29750.00, 1, 'Dispersante base solvente para esmaltes. Tambor 200 kg', 32, 338, 9, 1.000000, NULL),
(87, 'SILOEN LA 271', 'LA271', 'Materia Prima', 80000.00, 95200.00, 1, 'Nivelante. Cunete 20 kg', 32, 339, 9, 1.000000, NULL),
(88, 'SILOEN DA290', 'DA290', 'Materia Prima', 90000.00, 107100.00, 1, 'Antiespumante para epoxicos. Cunete 20 kg', 32, 340, 9, 1.000000, NULL),
(89, 'AZUL 15.3', NULL, 'Materia Prima', 29500.00, 35105.00, 1, 'Pigmento Azul Ftalo PB15:3', 32, 68, 9, 1.000000, NULL),
(90, 'VERDE 7', NULL, 'Materia Prima', 31000.00, 36890.00, 1, 'Pigmento Verde Ftalo PG7', 32, 67, 9, 1.000000, NULL),
(91, 'CROMATO DE ZINC', NULL, 'Materia Prima', 19000.00, 22610.00, 1, 'Pigmento Cromato de Zinc', 32, 267, 9, 1.000000, NULL),
(92, 'FOSFATO DE ZINC', NULL, 'Materia Prima', 20500.00, 24395.00, 1, 'Pigmento Fosfato de Zinc', 32, 236, 9, 1.000000, NULL),
(93, 'AMARILLO CROMO MEDIO', NULL, 'Materia Prima', 20500.00, 24395.00, 1, 'Pigmento Amarillo Cromo Medio', 32, 341, 9, 1.000000, NULL),
(94, 'CAOLIN CALCINADO', NULL, 'Materia Prima', 2900.00, 3451.00, 1, 'Caolin Calcinado', 32, 253, 9, 1.000000, NULL),
(95, 'HUMECTANTE BASE AGUA CERO VOC', NULL, 'Materia Prima', 29000.00, 34510.00, 1, 'Humectante base agua, cero VOC', 32, 342, 9, 1.000000, NULL),
(96, 'ACRONAL (resina acrilica estirenada)', NULL, 'Materia Prima', 7563.03, 9000.00, 1, 'kg ex-bulto 20kg, IVA incl', 33, 255, 9, 1.000000, NULL),
(97, 'LATECOL (espesante acrilico)', NULL, 'Materia Prima', 7563.03, 9000.00, 1, 'kg ex-bulto 20kg, IVA incl', 33, 335, 9, 1.000000, NULL),
(98, 'PVA (resina vinil acrilica 50-55%)', NULL, 'Materia Prima', 6722.69, 8000.00, 1, 'kg ex-bulto 20kg, IVA incl', 33, 301, 9, 1.000000, NULL),
(99, 'TEXANOL / COALESCENTE', NULL, 'Materia Prima', 14705.88, 17500.00, 1, 'kg ex-bulto 20kg, IVA incl', 33, 254, 9, 1.000000, NULL),
(100, 'ANTIESPUMANTE', NULL, 'Materia Prima', 9663.87, 11500.00, 1, 'kg ex-bulto 20kg, IVA incl', 33, 249, 9, 1.000000, NULL),
(101, 'DISPERSANTE', NULL, 'Materia Prima', 5546.22, 6600.00, 1, 'kg ex-bulto 25kg, IVA incl', 33, 231, 9, 1.000000, NULL),
(102, 'OMYACARB UF', NULL, 'Materia Prima', 2352.94, 2800.00, 1, 'kg ex-bulto 25kg, IVA incl', 33, 57, 9, 1.000000, NULL),
(103, 'TALCO TY 400', NULL, 'Materia Prima', 1722.69, 2050.00, 1, 'kg ex-bulto 40kg, IVA incl', 33, 252, 9, 1.000000, NULL),
(104, 'CAOLINA TIZA CAOMIN', NULL, 'Materia Prima', 2890.76, 3440.00, 1, 'kg ex-25kg ASUMIDO, confirmar', 33, 253, 9, 1.000000, NULL),
(105, 'DIOXIDO DE TITANIO', NULL, 'Materia Prima', 12100.84, 14400.00, 1, 'kg ex-bulto 25kg, IVA incl', 33, 37, 9, 1.000000, NULL),
(106, 'HUMECTANTE', NULL, 'Materia Prima', 12184.87, 14500.00, 1, 'kg ex-bulto 20kg, IVA incl', 33, 342, 9, 1.000000, NULL),
(107, 'HIDROFUGANTE MATE', NULL, 'Materia Prima', 10084.03, 12000.00, 1, 'kg ex-cunete 20kg, IVA incl', 33, 343, 9, 1.000000, NULL),
(108, 'HIDROFUGANTE BRILLANTE', NULL, 'Materia Prima', 11764.71, 14000.00, 1, 'kg ex-cunete 20kg, IVA incl', 33, 344, 9, 1.000000, NULL),
(109, 'BIOCIDA DA PLUS', NULL, 'Materia Prima', 9243.70, 11000.00, 1, 'kg ex-bulto 20kg, IVA incl', 33, 345, 9, 1.000000, NULL),
(110, 'BIOCIDA DA ULTRA', NULL, 'Materia Prima', 14285.71, 17000.00, 1, 'kg ex-bulto 20kg, IVA incl', 33, 346, 9, 1.000000, NULL),
(111, 'OMYACARB 15', NULL, 'Materia Prima', 571.43, 680.00, 1, 'kg ex-bulto 25kg, IVA incl', 33, 347, 9, 1.000000, NULL),
(112, 'OMYACARB 4', NULL, 'Materia Prima', 840.34, 1000.00, 1, 'kg ex-bulto 25kg, IVA incl', 33, 348, 9, 1.000000, NULL),
(113, 'TALCO EXTRA', NULL, 'Materia Prima', 1323.53, 1575.00, 1, 'kg ex-bulto 40kg, IVA incl', 33, 349, 9, 1.000000, NULL),
(114, 'TALCO EXTRA MEJORADO', NULL, 'Materia Prima', 1575.63, 1875.00, 1, 'kg ex-bulto 40kg, IVA incl', 33, 350, 9, 1.000000, NULL);
...
(7, '2026-05-11-000001', 'App\\Database\\Migrations\\AddRolToUsuarios', 'default', 'App', 1778543978, 5),
(8, '2026-05-11-000002', 'App\\Database\\Migrations\\CreatePermisosRolModulo', 'default', 'App', 1778543978, 5),
(9, '2026-05-11-000003', 'App\\Database\\Migrations\\CreateLoginAttempts', 'default', 'App', 1778543998, 6),
(10, '2026-05-13-000001', 'App\\Database\\Migrations\\ExtendMovimientoInventario', 'default', 'App', 1778685332, 7),
(11, '2026-05-13-000002', 'App\\Database\\Migrations\\AddNombreToUsuarios', 'default', 'App', 1778689057, 8),
(12, '2026-05-13-000003', 'App\\Database\\Migrations\\AddLoteProveedorToProduccionInsumos', 'default', 'App', 1778689809, 9),
(13, '2026-05-13-000004', 'App\\Database\\Migrations\\CreateFormulacionesVersiones', 'default', 'App', 1778690919, 10),
(14, '2026-05-13-000005', 'App\\Database\\Migrations\\CreateNotificaciones', 'default', 'App', 1778691884, 11),
(15, '2026-05-13-000006', 'App\\Database\\Migrations\\AddSugeridaToRequisiciones', 'default', 'App', 1778692918, 12),
(17, '2026-05-13-000007', 'App\\Database\\Migrations\\AddSoftDeletes', 'default', 'App', 1778701102, 14),
(18, '2026-05-13-000008', 'App\\Database\\Migrations\\RemisionesStockTracking', 'default', 'App', 1778702058, 15),
(57, '2026-05-14-000001', 'App\\Database\\Migrations\\AddSoftDeleteToItemProveedor', 'default', 'App', 1779725132, 16),
...
(62, '2026-05-14-000006', 'App\\Database\\Migrations\\ExtendEmpresa', 'default', 'App', 1779725132, 16),
(63, '2026-05-14-000007', 'App\\Database\\Migrations\\SeedConfiguracionSeguridadFinanciero', 'default', 'App', 1779725132, 16),
(64, '2026-05-14-000008', 'App\\Database\\Migrations\\SeedAvatarPalette', 'default', 'App', 1779725132, 16),
(65, '2026-05-14-000009', 'App\\Database\\Migrations\\SeedDefaultLogo', 'default', 'App', 1779725132, 16),
...
(72, '2026-05-20-000001', 'App\\Database\\Migrations\\AddSaludSistemaModulo', 'default', 'App', 1779725132, 16),
...
(76, '2026-05-25-000001', 'App\\Database\\Migrations\\CreateRefreshTokens', 'default', 'App', 1779898393, 17),
(77, '2026-05-25-000002', 'App\\Database\\Migrations\\DropTamboresTable', 'default', 'App', 1779898393, 17),
(78, '2026-05-27-000001', 'App\\Database\\Migrations\\AddSoftDeleteToBasicEntities', 'default', 'App', 1780074079, 18);
...
INSERT INTO `movimiento_inventario` (`id_movimiento_inventario`, `tipo_movimiento`, `cantidad`, `fecha_movimiento`, `descripcion`, `referencia_tipo`, `item_general_id`, `bodega_id`, `referencia_id`, `costo_unitario`, `saldo_anterior`, `saldo_nuevo`, `responsable`, `metadata`, `created_at`) VALUES
(36, 'ENTRADA', 1000.00, '2026-05-16 15:55:15', 'Recepción OC #OC-001 línea 47', 'ORDEN_COMPRA', 300, 1, 36, 5040.00, 0.00, 1000.00, 'root', '{\"numero_oc\": \"OC-001\", \"proveedor_id\": \"31\", \"unidad_compra\": \"9\", \"lote_proveedor\": \"LT-2026-A0450\", \"factor_conversion\": 1, \"item_proveedor_id\": \"78\", \"precio_unit_compra\": 5040, \"item_proveedor_nombre\": \"PVA RESIFLEX 610\", \"cantidad_recibida_unidad_compra\": 1000}', '2026-05-16 15:55:15'),
(50, 'ENTRADA', 200.00, '2026-05-17 01:12:21', 'Recepción OC #OC-001 línea 48', 'ORDEN_COMPRA', 301, 1, 36, 7620.00, 0.00, 200.00, 'root', '{\"numero_oc\": \"OC-001\", \"proveedor_id\": \"31\", \"unidad_compra\": \"9\", \"lote_proveedor\": \"LT-2026-A0450\", \"factor_conversion\": 1, \"item_proveedor_id\": \"79\", \"precio_unit_compra\": 7620, \"item_proveedor_nombre\": \"PVA RESIFLEX F55M\", \"cantidad_recibida_unidad_compra\": 200}', '2026-05-17 01:12:21'),
(51, 'AJUSTE', 5.00, '2026-05-18 20:06:26', 'Ajuste manual: removido de bodega Bodega principal', 'AJUSTE_MANUAL', 133, 1, NULL, NULL, 5.00, 0.00, 'root', '{\"accion\": \"remove_from_bodega\", \"motivo\": null, \"bodega_id\": 1, \"bodega_nombre\": \"Bodega principal\", \"cantidad_removida\": 5}', '2026-05-18 20:06:26'),
(52, 'ENTRADA', 10.00, '2026-05-25 14:59:54', 'Recepción OC #OC-020 línea 53', 'ORDEN_COMPRA', 230, 1, 39, 5000.00, 0.00, 10.00, 'root', '{\"numero_oc\": \"OC-020\", \"proveedor_id\": \"23\", \"unidad_compra\": null, \"lote_proveedor\": \"TEST-LOTE-6a1463ead3dd0\", \"factor_conversion\": 1, \"item_proveedor_id\": \"46\", \"precio_unit_compra\": 5000, \"item_proveedor_nombre\": \"DISPERSANTE\", \"cantidad_recibida_unidad_compra\": 10}', '2026-05-25 14:59:54'),
(53, 'SALIDA', 1.50, '2026-05-25 14:59:56', 'Despacho remisión REM-2026-0001 línea 17', 'REMISION', 1, 1, 18, 0.00, 11.00, 9.50, 'root', '{\"cliente_id\": \"1\", \"detalle_id\": 17, \"descripcion\": \"Test despacho\", \"remision_id\": 18, \"remision_numero\": \"REM-2026-0001\", \"capas_consumidas\": 1}', '2026-05-25 14:59:56'),
(54, 'ENTRADA', 1.50, '2026-05-25 14:59:57', 'Anulación remisión REM-2026-0001 (reintegro de stock)', 'ANULACION', 1, NULL, 18, 0.00, 9.50, 11.00, 'root', '{\"remision_id\": 18, \"origen_estado\": \"Despachada\", \"remision_numero\": \"REM-2026-0001\", \"capas_restauradas\": 1}', '2026-05-25 14:59:57'),
(55, 'ENTRADA', 10.00, '2026-05-25 16:04:45', 'Recepción OC #OC-022 línea 55', 'ORDEN_COMPRA', 230, 1, 41, 5000.00, 10.00, 20.00, 'root', '{\"numero_oc\": \"OC-022\", \"proveedor_id\": \"23\", \"unidad_compra\": null, \"lote_proveedor\": \"TEST-LOTE-6a14731da95e8\", \"factor_conversion\": 1, \"item_proveedor_id\": \"46\", \"precio_unit_compra\": 5000, \"item_proveedor_nombre\": \"DISPERSANTE\", \"cantidad_recibida_unidad_compra\": 10}', '2026-05-25 16:04:45'),
(56, 'SALIDA', 1.50, '2026-05-25 16:04:48', 'Despacho remisión REM-2026-0003 línea 19', 'REMISION', 1, 1, 20, 0.00, 9.50, 8.00, 'root', '{\"cliente_id\": \"1\", \"detalle_id\": 19, \"descripcion\": \"Test despacho\", \"remision_id\": 20, \"remision_numero\": \"REM-2026-0003\", \"capas_consumidas\": 1}', '2026-05-25 16:04:48'),
(57, 'ENTRADA', 1.50, '2026-05-25 16:04:48', 'Anulación remisión REM-2026-0003 (reintegro de stock)', 'ANULACION', 1, NULL, 20, 0.00, 9.50, 11.00, 'root', '{\"remision_id\": 20, \"origen_estado\": \"Despachada\", \"remision_numero\": \"REM-2026-0003\", \"capas_restauradas\": 1}', '2026-05-25 16:04:48'),
(58, 'ENTRADA', 1000.00, '2026-05-27 20:42:54', 'Recepción OC #OC-002 línea 49', 'ORDEN_COMPRA', 300, 1, 37, 5040.00, 1000.00, 2000.00, 'root', '{\"numero_oc\": \"OC-002\", \"proveedor_id\": \"31\", \"unidad_compra\": \"9\", \"lote_proveedor\": \"LOT-OC37-20260527\", \"factor_conversion\": 1, \"item_proveedor_id\": \"78\", \"precio_unit_compra\": 5040, \"item_proveedor_nombre\": \"PVA RESIFLEX 610\", \"cantidad_recibida_unidad_compra\": 1000}', '2026-05-27 20:42:54'),
(59, 'ENTRADA', 1000.00, '2026-05-27 21:00:27', 'Recepción OC #OC-002 línea 49', 'ORDEN_COMPRA', 300, 1, 37, 5040.00, 1000.00, 2000.00, 'root', '{\"numero_oc\": \"OC-002\", \"proveedor_id\": \"31\", \"unidad_compra\": \"9\", \"lote_proveedor\": \"LOT-OC37-20260527\", \"factor_conversion\": 1, \"item_proveedor_id\": \"78\", \"precio_unit_compra\": 5040, \"item_proveedor_nombre\": \"PVA RESIFLEX 610\", \"cantidad_recibida_unidad_compra\": 1000}', '2026-05-27 21:00:27');
...
INSERT INTO `notificaciones` (`id`, `user_id`, `rol_target`, `tipo`, `titulo`, `mensaje`, `link`, `leida`, `leida_at`, `metadata`, `created_at`) VALUES
(1, NULL, 'admin', 'factura_vencimiento', 'Factura FAC-20 en mora', 'Distribuidora Andina S.A.S · 154 días vencida · saldo $125.000', '/cartera', 1, '2026-05-16 19:56:12', '{\"saldo\": 125000, \"dedup_key\": \"factura-mora-1-2026-05-15\", \"dias_mora\": 154, \"id_facturas\": 1}', '2026-05-15 19:11:42');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `numeracion_documentos`
--

CREATE TABLE `numeracion_documentos` (
  `id_numeracion` int UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `numeracion_documentos`
--

INSERT INTO `numeracion_documentos` (`id_numeracion`, `tipo_doc`, `prefijo`, `padding`, `proximo_numero`, `anio_actual`, `reinicia_anual`, `resolucion_dian`, `fecha_resolucion`, `rango_min`, `rango_max`, `fecha_vigencia_hasta`, `activo`, `created_at`, `updated_at`, `updated_by`) VALUES
(1, 'factura', 'FAC-{Y}-', 4, 1, 2026, 1, NULL, NULL, NULL, NULL, NULL, 1, '2026-05-25 16:05:32', '2026-05-25 16:05:32', 'migration'),
(2, 'cotizacion', 'COT-{Y}-', 4, 1, 2026, 1, NULL, NULL, NULL, NULL, NULL, 1, '2026-05-25 16:05:32', '2026-05-25 16:05:32', 'migration'),
(3, 'remision', 'REM-{Y}-', 4, 5, 2026, 1, NULL, NULL, NULL, NULL, NULL, 1, '2026-05-25 16:05:32', '2026-05-25 16:05:32', 'migration'),
(4, 'orden_compra', 'OC-', 3, 4, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1, '2026-05-25 16:05:32', '2026-05-27 16:38:46', 'migration'),
(5, 'nota_credito', 'NC-', 3, 1, NULL, 0, NULL, NULL, NULL, NULL, NULL, 1, '2026-05-25 16:05:32', '2026-05-25 16:05:32', 'migration');
...
INSERT INTO `ordenes_compra` (`id_orden`, `numero`, `proveedor_id`, `bodegas_id`, `fecha`, `fecha_esperada`, `estado`, `total`, `iva_pct`, `observaciones`, `creado_en`, `deleted_at`) VALUES
(36, 'OC-001', 31, 1, '2026-05-07', '2026-05-07', 'Recibida', 6564000.00, 19.00, '', '2026-05-16 15:50:09', NULL),
(37, 'OC-002', 31, 1, '2026-05-15', '2026-05-18', 'Recibida', 5040000.00, 19.00, '', '2026-05-16 15:52:32', NULL),
(45, 'OC-003', 30, 1, '2026-05-27', '2026-06-03', 'Enviada', 1094118.20, 19.00, 'OC de ejemplo (borrador) - 3 productos de BRENTANG', '2026-05-27 20:51:05', NULL);
...
(47, 36, 78, 300, 'PVA RESIFLEX 610', 1000.00, 5040.00, 5040000.00, 1000.00, '2026-05-16 15:55:15'),
(48, 36, 79, 301, 'PVA RESIFLEX F55M', 200.00, 7620.00, 1524000.00, 200.00, '2026-05-17 01:12:21'),
(49, 37, 78, 300, 'PVA RESIFLEX 610', 1000.00, 5040.00, 5040000.00, 1000.00, '2026-05-27 21:00:27'),
(57, 45, 75, 225, 'XILOL', 100.00, 5714.29, 571429.00, 0.00, NULL),
(58, 45, 76, 244, 'ISOBUTANOL', 50.00, 5966.39, 298319.50, 0.00, NULL),
(59, 45, 77, 245, 'BUTIL GLICOL', 30.00, 7478.99, 224369.70, 0.00, NULL);
...
INSERT INTO `permisos_rol_modulo` (`id`, `rol`, `modulo`, `activo`) VALUES
(1, 'admin', 'panel-principal', 1),
(2, 'admin', 'catalogo', 1),
(3, 'admin', 'inventario-global', 1),
(4, 'admin', 'formulaciones', 1),
(5, 'admin', 'produccion', 1),
(6, 'admin', 'rentabilidad', 1),
(7, 'admin', 'comercial', 1),
(8, 'admin', 'compras', 1),
(9, 'admin', 'cartera', 1),
(10, 'admin', 'clientes', 1),
(11, 'admin', 'proveedores', 1),
(12, 'admin', 'movimientos', 1),
(13, 'admin', 'pagos', 1),
(16, 'admin', 'roles', 1),
(17, 'operador', 'panel-principal', 1),
(18, 'operador', 'catalogo', 1),
(19, 'operador', 'inventario-global', 1),
(20, 'operador', 'formulaciones', 1),
(21, 'operador', 'produccion', 1),
(22, 'operador', 'compras', 1),
(23, 'operador', 'clientes', 1),
(24, 'operador', 'proveedores', 1),
(25, 'operador', 'movimientos', 1),
(26, 'operador', 'pagos', 1),
(69, 'visor', 'panel-principal', 1),
(70, 'visor', 'catalogo', 1),
(71, 'visor', 'inventario-global', 1),
(72, 'visor', 'formulaciones', 1),
(73, 'visor', 'rentabilidad', 1),
(74, 'visor', 'comercial', 1),
(75, 'visor', 'clientes', 1),
(76, 'visor', 'proveedores', 1),
(77, 'visor', 'movimientos', 1),
(115, 'admin', 'trazabilidad', 1),
(116, 'operador', 'trazabilidad', 1),
(117, 'visor', 'trazabilidad', 1),
(121, 'admin', 'costos-produccion', 1),
(122, 'operador', 'costos-produccion', 1),
(123, 'visor', 'costos-produccion', 1),
(124, 'admin', 'salud-sistema', 1),
(125, 'operador', 'salud-sistema', 1),
(126, 'visor', 'salud-sistema', 1),
(127, 'superadmin', 'cartera', 1),
(128, 'superadmin', 'catalogo', 1),
(129, 'superadmin', 'clientes', 1),
(130, 'superadmin', 'comercial', 1),
(131, 'superadmin', 'compras', 1),
(132, 'superadmin', 'costos-produccion', 1),
(133, 'superadmin', 'formulaciones', 1),
(134, 'superadmin', 'inventario-global', 1),
(135, 'superadmin', 'movimientos', 1),
(136, 'superadmin', 'pagos', 1),
(137, 'superadmin', 'panel-principal', 1),
(138, 'superadmin', 'produccion', 1),
(139, 'superadmin', 'proveedores', 1),
(140, 'superadmin', 'rentabilidad', 1),
(141, 'superadmin', 'roles', 1),
(142, 'superadmin', 'salud-sistema', 1),
(143, 'superadmin', 'trazabilidad', 1);
...
INSERT INTO `proveedor` (`id_proveedor`, `nombre_encargado`, `nombre_empresa`, `numero_documento`, `direccion`, `telefono`, `email`, `deleted_at`) VALUES
(23, 'MARTHA PINO VILLA', 'COLARQUIM', '800226277-6', 'Cl. 110 #75A-620 Bodega 14, Riomar', '3135730324', 'servicioalclientebq@colarquim.com', NULL),
(24, 'PMA', 'PMA', '1004914866', '', '', '', NULL),
(25, 'LILIANA HERRERA', 'CONQUIMICA', '890919549', '', '3113676010', '', NULL),
(26, 'Carlos Pérez', 'RECIEND', '1', '', '', '', NULL),
(27, 'María Gómez', 'PROQUIMICOS', '1', '', '310 3782317', '', NULL),
(28, 'Carlos Rodríguez', 'PROCESOS Y DISOLVENTES', '1', '', '', '', NULL),
(29, 'María Gómez', 'EVER POL', '1', '', '', '', NULL),
(30, 'DIANA PEREZ', 'BRENTANG', '10001914855', 'Cl. 30 #15-360, Barranquilla', '', '', NULL),
(31, 'XIOMARA ', 'PREFLEX', '860508470-0', 'Cra 2 #56-25, CAZUCA', '3106793731', 'xpineda@preflex.com.co', NULL),
(32, 'María Gómez', 'isGroup', '800987654-2', '', '', '', NULL),
(33, NULL, 'distriatlantico', '900751588-5', NULL, NULL, NULL, NULL);
...
INSERT INTO `refresh_tokens` (`id`, `usuario_id`, `token_hash`, `expires_at`, `created_at`, `revoked`) VALUES
(3, 2, 'e9d5febaf1ce5966791afceed3fd1407fd7a790d09bab103635bd321bd26002b', '2026-06-03 20:36:42', '2026-05-27 20:36:42', 0),
(4, 2, '523553bf1e83f5f1cdaefd70ddf49d82734e8cc5b3f2908e5b99c6fa5821c888', '2026-06-05 16:54:48', '2026-05-29 16:54:48', 0),
(5, 2, '1b3424b2f8b31473a4fded36a16bea3edb64f9bebb7eb422d82687567d907de1', '2026-06-06 14:25:18', '2026-05-30 14:25:18', 0),
(6, 2, 'b9e833fc48da19809bb6176c5704f86a4c3da38d77f92d89a1e198d3ab516fc4', '2026-06-06 14:25:30', '2026-05-30 14:25:30', 0);
...
INSERT INTO `remisiones` (`id_remisiones`, `numero`, `cliente_id`, `fecha_remision`, `estado`, `direccion_entrega`, `observaciones`, `facturas_id`, `movimiento_inventario_id`, `creado_en`, `deleted_at`) VALUES
(18, 'REM-2026-0001', 1, '2026-05-25', 'Anulada', NULL, NULL, NULL, NULL, '2026-05-25 14:59:56', NULL),
(19, 'REM-2026-0002', 1, '2026-05-25', 'Pendiente', NULL, NULL, NULL, NULL, '2026-05-25 14:59:57', NULL),
(20, 'REM-2026-0003', 1, '2026-05-25', 'Anulada', NULL, NULL, NULL, NULL, '2026-05-25 16:04:47', NULL),
(21, 'REM-2026-0004', 1, '2026-05-25', 'Pendiente', NULL, NULL, NULL, NULL, '2026-05-25 16:04:48', NULL);
...
INSERT INTO `remisiones_detalle` (`id_detalle`, `remisiones_id`, `item_general_id`, `bodega_id`, `descripcion`, `cantidad`, `precio_unit`, `subtotal`) VALUES
(17, 18, 1, 1, 'Test despacho', 1.50, 10000.00, 15000.00),
(18, 19, 1, NULL, 'Test sin stock', 999999.00, 1.00, 999999.00),
(19, 20, 1, 1, 'Test despacho', 1.50, 10000.00, 15000.00),
(20, 21, 1, NULL, 'Test sin stock', 999999.00, 1.00, 999999.00);
...
INSERT INTO `unidad` (`id_unidad`, `nombre`, `descripcion`, `estados`, `escala`, `deleted_at`) VALUES
(1, 'TAMBOR', '', 1, 50.00000, NULL),
(2, 'CUÑETE', '', 1, 5.00000, NULL),
(3, 'GALON', '', 1, 1.00000, NULL),
(4, '1/2 GALON', '', 1, 0.50000, NULL),
(5, '1/4 GALON', '', 1, 0.25000, NULL),
(6, '1/8 GALON', '', 1, 0.12500, NULL),
(7, '1/16 GALON', '', 1, 0.06250, NULL),
(8, '1/32 GALON', '', 1, 0.03125, NULL),
(9, 'KILO', '', 1, 1.00000, NULL),
(10, 'GRAMO', '', 1, 0.00100, NULL),
(11, 'LIBRA', '', 1, 0.45300, NULL),
(12, 'LITRO', '', 1, 0.26417, NULL),
(13, 'UNIDAD', NULL, NULL, 1.00000, NULL),
(14, 'CAJA', NULL, NULL, 1.00000, NULL),
(15, 'BULTO', NULL, NULL, 1.00000, NULL),
(16, 'CANECA', NULL, NULL, 1.00000, NULL);
...
INSERT INTO `usuarios` (`id_usuarios`, `username`, `nombre`, `password`, `rol`, `password_must_change`, `token_version`) VALUES
(2, 'root', 'Jorge Herrera', '$2y$10$zcSxsrQHkHFxPddPk/.TFeeFceYqtUeb3wtlLSxfnDG4Ll5dL1Szu', 'admin', 0, 1),
(5, '1juanherrera', 'Juan Herrera', '$2y$10$gbWzSg/j.GwJHlMT9LKKMujex17dmeanFGm2myxFAyRl7f.jh/J8a', 'superadmin', 1, 1);
...
--
-- Indices de la tabla `costos_snapshot`
--
ALTER TABLE `costos_snapshot`
  ADD PRIMARY KEY (`id_costos_snapshot`),
  ADD UNIQUE KEY `uq_snapshot_item_fecha` (`item_general_id`,`fecha`),
  ADD KEY `item_general_id_fecha` (`item_general_id`,`fecha`),
  ADD KEY `fecha` (`fecha`);
...
ALTER TABLE `cotizaciones`
  ...
  ADD KEY `idx_cotizaciones_deleted_at` (`deleted_at`);
...
ALTER TABLE `facturas`
  ...
  ADD KEY `idx_facturas_deleted_at` (`deleted_at`);
...
--
-- Indices de la tabla `formulaciones_versiones`
--
ALTER TABLE `formulaciones_versiones`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_formulacion_version` (`formulacion_id`,`version_num`),
  ADD KEY `idx_fv_formulacion` (`formulacion_id`);
...
ALTER TABLE `item_general`
  ...
  ADD KEY `idx_item_general_deleted_at` (`deleted_at`);
...
ALTER TABLE `item_proveedor`
  ...
  ADD KEY `idx_item_proveedor_deleted_at` (`deleted_at`);
...
ALTER TABLE `notificaciones`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_notif_user_leida` (`user_id`,`leida`),
  ADD KEY `idx_notif_rol_leida` (`rol_target`,`leida`),
  ADD KEY `idx_notif_tipo` (`tipo`),
  ADD KEY `idx_notif_created` (`created_at`);

--
-- Indices de la tabla `numeracion_documentos`
--
ALTER TABLE `numeracion_documentos`
  ADD PRIMARY KEY (`id_numeracion`),
  ADD KEY `tipo_doc_activo` (`tipo_doc`,`activo`);
...
ALTER TABLE `ordenes_compra`
  ...
  ADD KEY `bodegas_id` (`bodegas_id`),
  ADD KEY `idx_ordenes_compra_deleted_at` (`deleted_at`);
...
ALTER TABLE `preparaciones`
  ...
  ADD KEY `idx_prep_form_ver` (`formulacion_version_id`);
...
ALTER TABLE `produccion_insumos_detalle`
  ...
  ADD KEY `idx_pid_lote` (`lote_proveedor`);
...
ALTER TABLE `proveedor`
  ...
  ADD KEY `idx_proveedor_deleted_at` (`deleted_at`);
...
ALTER TABLE `remisiones`
  ...
  ADD KEY `idx_remisiones_deleted_at` (`deleted_at`);
...
ALTER TABLE `remisiones_detalle`
  ...
  ADD KEY `idx_remdet_item` (`item_general_id`);
...
--
ALTER TABLE `clientes`
  MODIFY `id_clientes` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT de la tabla `configuracion_sistema`
--
ALTER TABLE `configuracion_sistema`
  MODIFY `id_configuracion` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `costos_item`
  MODIFY `id_costos_item` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=207;
...
--
-- AUTO_INCREMENT de la tabla `costos_snapshot`
--
ALTER TABLE `costos_snapshot`
  MODIFY `id_costos_snapshot` int UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `facturas`
  MODIFY `id_facturas` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `formulaciones`
  MODIFY `id_formulaciones` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT de la tabla `formulaciones_versiones`
--
ALTER TABLE `formulaciones_versiones`
...
--
ALTER TABLE `inventario`
  MODIFY `id_inventario` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=285;

--
-- AUTO_INCREMENT de la tabla `inventario_capas`
--
ALTER TABLE `inventario_capas`
  MODIFY `id_capa` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=173;

--
-- AUTO_INCREMENT de la tabla `item_general`
--
ALTER TABLE `item_general`
  MODIFY `id_item_general` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=351;

--
-- AUTO_INCREMENT de la tabla `item_general_formulaciones`
--
ALTER TABLE `item_general_formulaciones`
  MODIFY `id_item_general_formulaciones` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=868;

--
-- AUTO_INCREMENT de la tabla `item_proveedor`
--
ALTER TABLE `item_proveedor`
  MODIFY `id_item_proveedor` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;
...
--
ALTER TABLE `movimiento_inventario`
  MODIFY `id_movimiento_inventario` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT de la tabla `notas_credito`
--
ALTER TABLE `notas_credito`
  MODIFY `id_nota_credito` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
-- AUTO_INCREMENT de la tabla `numeracion_documentos`
--
ALTER TABLE `numeracion_documentos`
  MODIFY `id_numeracion` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `ordenes_compra`
--
ALTER TABLE `ordenes_compra`
  MODIFY `id_orden` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT de la tabla `ordenes_compra_detalle`
--
ALTER TABLE `ordenes_compra_detalle`
  MODIFY `id_detalle` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT de la tabla `pagos_cliente`
--
ALTER TABLE `pagos_cliente`
  MODIFY `id_pagos_cliente` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `preparaciones`
  MODIFY `id_preparaciones` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `proveedor`
  MODIFY `id_proveedor` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `remisiones`
  MODIFY `id_remisiones` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de la tabla `remisiones_detalle`
--
ALTER TABLE `remisiones_detalle`
  MODIFY `id_detalle` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
-- Filtros para la tabla `formulaciones_versiones`
--
ALTER TABLE `formulaciones_versiones`
  ADD CONSTRAINT `formulaciones_versiones_formulacion_id_foreign` FOREIGN KEY (`formulacion_id`) REFERENCES `formulaciones` (`id_formulaciones`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `refresh_tokens`
  ADD CONSTRAINT `refresh_tokens_usuario_id_foreign` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id_usuarios`) ON DELETE CASCADE ON UPDATE CASCADE;
