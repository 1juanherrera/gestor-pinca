...
--
-- Servidor: db
-- Tiempo de generación: 21-04-2026 a las 22:06:04
...
CREATE TABLE `item_general` (
  ...
  `p_kg` varchar(14) COLLATE utf8mb4_general_ci NOT NULL,
...
INSERT INTO `item_proveedor` (`id_item_proveedor`, `nombre`, `codigo`, `tipo`, `unidad_empaque`, `precio_unitario`, `precio_con_iva`, `disponible`, `descripcion`, `proveedor_id`, `item_general_id`, `unidad_compra_id`, `factor_conversion`) VALUES
(6, 'Tubería PVC 1/2\" x 6m', 'PVC-12-6', 'Fontanería', 'Kg', 5000.00, 0.00, 1, 'Tubería de PVC para conducción de agua fría', 2, NULL, NULL, 1.000000),
(7, 'Codo PVC 1/2\" 90°', 'CDO-12-90', 'Fontanería', 'Kg', 2000.00, 1002.00, 1, 'Codo de PVC para unión de tuberías en ángulo recto', 2, NULL, NULL, 1.000000),
(8, 'Brocha 3 Pulgadas Profesional', 'BRC-3P', 'Herramientas ', 'Kg', 200.00, 500.00, 1, 'Brocha de cerdas sintéticas ideal para pintura acrílica', 2, NULL, NULL, 1.000000),
(9, 'Rodillo de Lana 9\"', 'RDL-9L', 'Herramientas', 'Kg', 0.00, 0.00, 1, 'Rodillo de lana para pintura en superficies rugosas', 2, NULL, NULL, 1.000000),
(10, 'Lija de Agua 220', 'LJ-220', 'Abrasivos', 'Kg', 0.00, 0.00, 1, 'Lija fina para acabado de superficies pintadas', 2, NULL, NULL, 1.000000),
(31, 'Tubería PVC 1/2\" x 6m', 'AQ-PVC-12', 'Fontanería', 'Kg', 4200.00, 4900.00, 1, 'Tubería PVC conducción agua fría', 8, NULL, NULL, 1.000000),
(32, 'Codo PVC 1/2\" 90°', 'AQ-CDO-12', 'Fontanería', 'Kg', 1750.00, 875.00, 1, 'Codo PVC 90 grados', 8, NULL, NULL, 1.000000),
(33, 'Brocha 3 Pulgadas Profesional', 'AQ-BRC-3P', 'Herramientas', 'Kg', 220.00, 550.00, 1, 'Brocha cerdas naturales', 8, NULL, NULL, 1.000000),
(34, 'Lija de Agua 220', 'AQ-LJ-220', 'Abrasivos', 'Kg', 280.00, 330.00, 1, 'Lija grano 220 acabado fino', 8, NULL, NULL, 1.000000),
(35, 'Pintura Epóxica Gris', 'AQ-EP-GR', 'Pinturas', 'Gal', 85000.00, 98000.00, 1, 'Pintura epóxica industrial', 8, NULL, NULL, 1.000000),
(36, 'Thinner Acrílico', 'AQ-TH-AC', 'Solventes', 'Gal', 22000.00, 25000.00, 1, 'Thinner para pintura acrílica', 8, NULL, NULL, 1.000000),
(37, 'Pintura Epóxica Gris', 'SL-EP-GR', 'Pinturas', 'Gal', 92000.00, 106000.00, 1, 'Pintura epóxica alta resistencia', 2, NULL, NULL, 1.000000),
(38, 'Thinner Acrílico', 'SL-TH-AC', 'Solventes', 'Gal', 19500.00, 22000.00, 1, 'Thinner acrílico industrial', 2, NULL, NULL, 1.000000),
(40, 'TALCO TY 400 G', 'QUI-MAT-0001', 'Materia Prima', NULL, 1504.00, 1790.00, 1, NULL, 23, NULL, NULL, 1.000000),
(41, 'OMIYACARB UF', 'QUI-MAT-0002', 'Materia Prima', NULL, 1828.00, 2175.00, 1, NULL, 23, NULL, NULL, 1.000000),
(42, 'COLARDIT ANTIESPUMANTE', 'QUI-ADIT-0001', 'Insumo', NULL, 7143.00, 8500.00, 1, NULL, 23, NULL, NULL, 1.000000),
(43, 'COLARCRYL ACRONAL 50', 'QUI-ADIT-0002', 'Insumo', NULL, 5252.00, 6250.00, 1, NULL, 23, NULL, NULL, 1.000000),
(44, 'COLARCIDE BACTERICIDA', 'QUI-BIO-0001', 'Insumo', NULL, 6387.00, 7600.00, 1, NULL, 23, NULL, NULL, 1.000000),
(45, 'COLARDIT REGULADOR PH', 'QUI-ADIT-0003', 'Insumo', NULL, 6555.00, 7800.00, 1, NULL, 23, NULL, NULL, 1.000000),
(46, 'COLARDIT DISPERSANTE', 'QUI-ADIT-0004', 'Insumo', NULL, 5378.00, 6400.00, 1, NULL, 23, NULL, NULL, 1.000000),
(47, 'COLARDIT AS ASOCIATIVO', 'QUI-ADIT-0005', 'Insumo', NULL, 9916.00, 11800.00, 1, NULL, 23, NULL, NULL, 1.000000),
(48, 'COLARBAG FUNGICIDA', 'QUI-BIO-0002', 'Insumo', NULL, 20840.00, 24800.00, 1, NULL, 23, NULL, NULL, 1.000000),
(49, 'BRITEX CALCINADO', 'QUI-MAT-0003', 'Materia Prima', NULL, 2605.00, 3100.00, 1, NULL, 23, NULL, NULL, 1.000000),
(50, 'WEKCELO C7 CELULOSICO', 'QUI-ESP-0001', 'Insumo', NULL, 18403.00, 21900.00, 1, NULL, 23, NULL, NULL, 1.000000),
(51, 'CARBONATO DE CALCIO M325', 'CARBM325', 'Materia Prima', 'Kilo', 300.00, 357.00, 1, '', 24, NULL, NULL, 1.000000),
(52, 'CARBONATO DE CALCIO M600', 'CARBM600', 'Materia Prima', 'Kilo', 460.00, 547.00, 1, '', 24, NULL, NULL, 1.000000),
(53, 'RESINA EPOXICA', 'NPSN CHINA', 'Materia Prima', 'Kilo', 15069.00, 17932.00, 1, '', 25, 226, NULL, 1.000000),
(54, 'RESINA KR 828 100%', 'KER828', 'Materia Prima', 'Kilo', 10300.00, 12257.00, 1, '', 26, NULL, NULL, 1.000000),
(55, 'ENDURECEDOR 100%', 'NT-1515X70', 'Materia Prima', 'Kilo', 20000.00, 23800.00, 1, '', 26, NULL, NULL, 1.000000),
(56, 'ENDURECEDOR 100%', 'NX-5454', 'Materia Prima', 'Kilo', 19700.00, 23443.00, 1, '', 26, NULL, NULL, 1.000000),
(57, 'XILOL', 'XIL21288', 'Materia Prima', 'Kilo', 6120.00, 7283.00, 1, '', 27, 225, NULL, 1.000000),
(58, 'THINNER ', 'TH2092', 'Materia Prima', 'Galon', 15961.00, 18994.00, 1, '', 27, NULL, NULL, 1.000000),
(59, 'VARSOL', 'VAR9218', 'Materia Prima', 'Kilo', 5961.00, 7094.00, 1, '', 27, NULL, NULL, 1.000000),
(60, 'VARSOL', 'VARPD281', 'Materia Prima', 'Kilo', 1230.00, 1464.00, 1, '', 28, NULL, NULL, 1.000000),
(61, 'THINNER', 'TH921298', 'Materia Prima', 'Galon', 880.00, 1047.00, 1, '', 28, 227, NULL, 1.000000),
(62, 'RESINA MEDIA EN SOYA AL 50%', 'RA-7', 'Materia Prima', 'Kilo', 6200.00, 7378.00, 1, '', 29, NULL, NULL, 1.000000),
(63, 'RESINA UREA FORMALDEHIDO', 'RN-9E', 'Materia Prima', 'Kilo', 8050.00, 9580.00, 1, '', 29, NULL, NULL, 1.000000),
(64, 'RESINA CORTA EN PALMISTE AL 55%', 'RA-4 ', 'Materia Prima', 'Kilo', 7350.00, 8747.00, 1, '', 29, NULL, NULL, 1.000000),
(65, 'RESINA CORTA EN SOYA AL 53%', 'RA-15', 'Materia Prima', 'Kilo', 6900.00, 8211.00, 1, '', 29, NULL, NULL, 1.000000),
(66, 'RESINA CORTA EN SOYA AL 55% (+ SOL)', 'RA-15M', 'Materia Prima', 'Kilo', 6900.00, 8211.00, 1, '', 29, NULL, NULL, 1.000000),
(67, 'RESINA CORTA EN SOYA AL 45%', 'RA-16', 'Materia Prima', 'Kilo', 6950.00, 8271.00, 1, '', 29, NULL, NULL, 1.000000),
(68, 'RESINA MALEICA SOLIDA', 'RM-1', 'Materia Prima', 'Kilo', 11300.00, 13447.00, 1, '', 29, NULL, NULL, 1.000000),
(69, 'RESINA MEDIA EN TOFA AL 50%', 'RA-22', 'Materia Prima', 'Kilo', 7550.00, 8985.00, 1, '', 29, NULL, NULL, 1.000000),
(70, 'RESINA MEDIA EN SOYA AL 50%', 'RA-23', 'Materia Prima', 'Kilo', 6350.00, 7557.00, 1, '', 29, NULL, NULL, 1.000000),
(71, 'RESINA LARGA EN SOYA AL 70%', 'RA-25', 'Materia Prima', 'Kilo', 7300.00, 8687.00, 1, '', 29, NULL, NULL, 1.000000),
(72, 'RESINA CHAIN STOPPED AL 60%', 'RA-37', 'Materia Prima', 'Kilo', 7200.00, 8568.00, 1, '', 29, NULL, NULL, 1.000000),
(73, 'RESINA CORTA EN TOFA AL 55%', 'RA-44', 'Materia Prima', 'Kilo', 8200.00, 9758.00, 1, '', 29, NULL, NULL, 1.000000),
(74, 'RESINA UREA FORMALDEHIDO', 'RN-9E', 'Materia Prima', 'Kilo', 8050.00, 9580.00, 1, '', 29, NULL, NULL, 1.000000);
...
CREATE TABLE `requisiciones_compra` (
  ...
  `estado` enum('PENDIENTE','APROBADA','CONVERTIDA','CANCELADA') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'PENDIENTE',
...
--
ALTER TABLE `item_general`
  MODIFY `id_item_general` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=228;
