...
--
-- Servidor: db
-- Tiempo de generación: 18-04-2026 a las 14:36:26
...
--
ALTER TABLE `item_proveedor`
  MODIFY `id_item_proveedor` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `proveedor`
  MODIFY `id_proveedor` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
