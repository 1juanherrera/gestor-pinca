...
--
-- Servidor: db
-- Tiempo de generación: 21-03-2026 a las 12:33:45
...
--
ALTER TABLE `ordenes_compra`
  MODIFY `id_orden` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `ordenes_compra_detalle`
--
ALTER TABLE `ordenes_compra_detalle`
  MODIFY `id_detalle` int UNSIGNED NOT NULL AUTO_INCREMENT;
